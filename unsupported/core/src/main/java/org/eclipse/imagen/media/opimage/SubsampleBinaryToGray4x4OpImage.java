 ...
 * the resulting image is defined to have the following bounds: <code>
...
class SubsampleBinaryToGray4x4OpImage extends GeometricOpImage {
    ...
    /**
     * Constructs a <code>SubsampleBinaryToGray4x4OpImage</code> from a <code>RenderedImage</code> source, an optional
