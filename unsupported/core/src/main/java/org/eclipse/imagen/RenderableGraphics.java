...
/**
 * An implementation of <code>Graphics2D</code> with <code>RenderableImage</code> semantics. In other words, content may
 * be drawn into the image using the <code>Graphics2D</code> interface and later be turned into <code>RenderedImage
 * </code>s with different resolutions and characteristics.
 *
 * <p>A <code>RenderableGraphics</code> occupies a region of the plane specified at the time of construction.
 *
 * <p>The contents of <code>RenderableImage</code>s that are drawn onto a <code>RenderableGraphics</code> are accessed
 * only at the time of rendering, not the time of drawing.
 *
 * <p>Since the methods of this class all derive from <code>Graphics2D</code> and <code>RenderableImage</code>, they are
 * not all commented individually.
 *
...
public class RenderableGraphics extends Graphics2D implements RenderableImage {
    ...
    /**
     * Constructs a <code>RenderableGraphics</code> given a bounding <code>Rectangle2D</code>.
     *
    ...
    /**
     * Constructs a <code>RenderableGraphics</code> given a bounding <code>Rectangle2D</code>, an origin, and a <code>
     * Graphics2D</code> object from which to initialize the <code>RenderableGraphics</code> state. The <code>Graphics2D
     * </code> may be null.
     *
     * @param dimensions The bounding <code>Rectangle2D</code>.
    ...
    /**
     * Creates a bogus <code>Graphics2D</code> object to be used to retrieve information dependent on system aspects
     * which are image-independent.
     *
     * <p>The <code>dispose()</code> method of the <code>Graphics2D</code> object returned should be called to free the
    ...
    private TiledImage createTiledImage(RenderingHints hints, Rectangle bounds) {
        ...
        if (sm != null) {
            ...
            ti = new TiledImage(bounds.x, bounds.y, bounds.width, bounds.height, bounds.x, bounds.y, sm, cm);
        } else {
            // Default to a PixelInterleaved TiledImage.
            ti = TiledImage.createInterleaved(
                    bounds.x,
                    bounds.y,
                    bounds.width,
                    bounds.height,
    ...
    /**
     * Queue a <code>Graphics2D</code> operation and its argument list in the linked list of operations and arguments.
     * The name of the operation and the array of class types of its arguments are used to determine the associated
     * <code>Method</code> object. The <code>Method</code> object and array of <code>Object</code> arguments are
     * appended to the list as an ordered pair of the form (<code>Method</code>,<code>Object</code>[]).
     *
     * @param name The name of the <code>Graphics2D</code> operation.
     * @param argTypes An array of the <code>Classes</code> of the arguments of the specified operation.
     * @param args The arguments of the operation as an array of <code>Object</code>s.
     */
    ...
    /**
     * Evaulate the queue of <code>Graphics2D</code> operations on the specified <code>Graphics2D</code> object.
     *
     * @param g2d The <code>Graphics2D</code> on which to evaluate the operation queue.
     */
    ...
    public void setColor(Color c) {
        ...
        queueOpArg("setColor", new Class[] {java.awt.Color.class}, new Object[] {c});
    }
    ...
    public void setXORMode(Color c1) {
        queueOpArg("setXORMode", new Class[] {java.awt.Color.class}, new Object[] {c1});
    }
    ...
    public void setFont(Font font) {
        ...
        queueOpArg("setFont", new Class[] {java.awt.Font.class}, new Object[] {font});
    }
    ...
    public void setClip(int x, int y, int width, int height) {
        ...
        queueOpArg("setClip", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height)
        });
    }
    ...
    public void setClip(Shape clip) {
        ...
        queueOpArg("setClip", new Class[] {java.awt.Shape.class}, new Object[] {clip});
    }
    ...
    public void drawLine(int x1, int y1, int x2, int y2) {
        queueOpArg("drawLine", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x1), new Integer(y1), new Integer(x2), new Integer(y2)
        });
    }

    public void fillRect(int x, int y, int width, int height) {
        queueOpArg("fillRect", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height)
        });
    }
    ...
    public void clearRect(int x, int y, int width, int height) {
        queueOpArg("clearRect", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height)
        });
    }
    ...
    public void draw3DRect(int x, int y, int width, int height, boolean raised) {
        queueOpArg("draw3DRect", new Class[] {int.class, int.class, int.class, int.class, boolean.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height), new Boolean(raised)
        });
    }
    ...
    public void fill3DRect(int x, int y, int width, int height, boolean raised) {
        queueOpArg("fill3DRect", new Class[] {int.class, int.class, int.class, int.class, boolean.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height), new Boolean(raised)
        });
    }

    public void drawOval(int x, int y, int width, int height) {
        queueOpArg("drawOval", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height)
        });
    }

    public void fillOval(int x, int y, int width, int height) {
        queueOpArg("fillOval", new Class[] {int.class, int.class, int.class, int.class}, new Object[] {
            new Integer(x), new Integer(y), new Integer(width), new Integer(height)
        });
    }
    ...
    public void drawPolyline(int xPoints[], int yPoints[], int nPoints) {
        ...
        queueOpArg("drawPolyline", new Class[] {intArrayClass, intArrayClass, int.class}, new Object[] {
            xPoints, yPoints, new Integer(nPoints)
        });
    }

    public void drawPolygon(int xPoints[], int yPoints[], int nPoints) {
        Class intArrayClass = xPoints.getClass();
        queueOpArg("drawPolygon", new Class[] {intArrayClass, intArrayClass, int.class}, new Object[] {
            xPoints, yPoints, new Integer(nPoints)
        });
    }
    ...
    public void fillPolygon(int xPoints[], int yPoints[], int nPoints) {
        Class intArrayClass = xPoints.getClass();
        queueOpArg("fillPolygon", new Class[] {intArrayClass, intArrayClass, int.class}, new Object[] {
            xPoints, yPoints, new Integer(nPoints)
        });
    }
    ...
    public void drawString(String str, int x, int y) {
        queueOpArg("drawString", new Class[] {java.lang.String.class, int.class, int.class}, new Object[] {
            str, new Integer(x), new Integer(y)
        });
    }
    ...
    public boolean drawImage(Image img, int x, int y, ImageObserver observer) {
        queueOpArg(
                ...
                new Object[] {img, new Integer(x), new Integer(y), observer});
        return true;
    }
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height, ImageObserver observer) {
        queueOpArg(
                "drawImage",
                new Class[] {
                    java.awt.Image.class, int.class, int.class, int.class, int.class, java.awt.image.ImageObserver.class
                },
                new Object[] {img, new Integer(x), new Integer(y), new Integer(width), new Integer(height), observer});
        return true;
    }
    ...
    public boolean drawImage(Image img, int x, int y, Color bgcolor, ImageObserver observer) {
        queueOpArg(
                "drawImage",
                new Class[] {
                    java.awt.Image.class, int.class, int.class, java.awt.Color.class, java.awt.image.ImageObserver.class
                },
                new Object[] {img, new Integer(x), new Integer(y), bgcolor, observer});
        return true;
    }
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height, Color bgcolor, ImageObserver observer) {
        queueOpArg(
                ...
                new Object[] {
                    img, new Integer(x), new Integer(y), new Integer(width), new Integer(height), bgcolor, observer
                });
        return true;
    }
    ...
    public void addRenderingHints(Map hints) {
        ...
        queueOpArg("addRenderingHints", new Class[] {java.util.Map.class}, new Object[] {hints});
    }

    public void draw(Shape s) {
        queueOpArg("draw", new Class[] {java.awt.Shape.class}, new Object[] {s});
    }
    ...
    public boolean drawImage(Image img, AffineTransform xform, ImageObserver obs) {
        queueOpArg(
                "drawImage",
                new Class[] {
                    java.awt.Image.class, java.awt.geom.AffineTransform.class, java.awt.image.ImageObserver.class
                },
    ...
    public void drawRenderedImage(RenderedImage img, AffineTransform xform) {
        ...
        queueOpArg(
                "drawRenderedImage",
                new Class[] {java.awt.image.RenderedImage.class, java.awt.geom.AffineTransform.class},
    ...
    public void drawRenderableImage(RenderableImage img, AffineTransform xform) {
        queueOpArg(
                "drawRenderableImage",
                new Class[] {java.awt.image.renderable.RenderableImage.class, java.awt.geom.AffineTransform.class},
                new Object[] {img, xform});
    }
    ...
    public void drawImage(BufferedImage img, BufferedImageOp op, int x, int y) {
        queueOpArg(
                "drawImage",
                new Class[] {
                    java.awt.image.BufferedImage.class, java.awt.image.BufferedImageOp.class, int.class, int.class
                },
                new Object[] {img, op, new Integer(x), new Integer(y)});
    }

    public void drawString(String s, float x, float y) {
        queueOpArg("drawString", new Class[] {java.lang.String.class, float.class, float.class}, new Object[] {
            s, new Float(x), new Float(y)
        });
    }
    ...
    public void drawString(AttributedCharacterIterator iterator, int x, int y) {
        queueOpArg(
                "drawString",
                new Class[] {java.text.AttributedCharacterIterator.class, int.class, int.class},
    ...
    public void drawString(AttributedCharacterIterator iterator, float x, float y) {
        queueOpArg(
                "drawString",
                new Class[] {java.text.AttributedCharacterIterator.class, float.class, float.class},
    ...
    public void drawGlyphVector(GlyphVector v, float x, float y) {
        queueOpArg(
                "drawGlyphVector",
                new Class[] {java.awt.font.GlyphVector.class, float.class, float.class},
                new Object[] {v, new Float(x), new Float(y)});
    }

    public void fill(Shape s) {
        queueOpArg("fill", new Class[] {java.awt.Shape.class}, new Object[] {s});
    }
    ...
    public void setComposite(Composite comp) {
        composite = comp;
        queueOpArg("setComposite", new Class[] {java.awt.Composite.class}, new Object[] {comp});
    }

    public void setPaint(Paint paint) {
        this.paint = paint;
        queueOpArg("setPaint", new Class[] {java.awt.Paint.class}, new Object[] {paint});
    }

    public void setStroke(Stroke s) {
        stroke = s;
        queueOpArg("setStroke", new Class[] {java.awt.Stroke.class}, new Object[] {s});
    }
    ...
    public void setRenderingHint(RenderingHints.Key hintKey, Object hintValue) {
        ...
        queueOpArg(
                "setRenderingHint",
                new Class[] {java.awt.RenderingHints.Key.class, java.lang.Object.class},
    ...
    public void setRenderingHints(Map hints) {
        ...
        queueOpArg("setRenderingHints", new Class[] {java.util.Map.class}, new Object[] {hints});
    }
    ...
    public void translate(int x, int y) {
        ...
        queueOpArg("translate", new Class[] {int.class, int.class}, new Object[] {new Integer(x), new Integer(y)});
    }

    public void translate(double x, double y) {
        transform.translate(x, y);

        queueOpArg("translate", new Class[] {double.class, double.class}, new Object[] {new Double(x), new Double(y)});
    }

    public void rotate(double theta) {
        transform.rotate(theta);

        queueOpArg("rotate", new Class[] {double.class}, new Object[] {new Double(theta)});
    }

    public void rotate(double theta, double x, double y) {
        transform.rotate(theta, x, y);

        queueOpArg("rotate", new Class[] {double.class, double.class, double.class}, new Object[] {
            new Double(theta), new Double(x), new Double(y)
        });
    }
    ...
    public void scale(double sx, double sy) {
        ...
        queueOpArg("scale", new Class[] {double.class, double.class}, new Object[] {new Double(sx), new Double(sy)});
    }

    public void shear(double shx, double shy) {
        transform.shear(shx, shy);

        queueOpArg("shear", new Class[] {double.class, double.class}, new Object[] {new Double(shx), new Double(shy)});
    }

    public void transform(AffineTransform Tx) {
        transform.concatenate(Tx);

        queueOpArg("transform", new Class[] {java.awt.geom.AffineTransform.class}, new Object[] {Tx});
    }

    public void setTransform(AffineTransform Tx) {
        transform = Tx;

        queueOpArg("setTransform", new Class[] {java.awt.geom.AffineTransform.class}, new Object[] {Tx});
    }
    ...
    public void setBackground(Color color) {
        ...
        queueOpArg("setBackground", new Class[] {java.awt.Color.class}, new Object[] {color});
    }
    ...
    public void clip(Shape s) {
        ...
        queueOpArg("clip", new Class[] {java.awt.Shape.class}, new Object[] {s});
    }
    ...
    /**
     * Creates a RenderedImage that represents a rendering of this image using a given RenderContext. This is the most
     ...
     *
     * <p>The bounds of the <code>RenderedImage</code> are determined from the dimensions parameter passed to the <code>
     * RenderableGraphics</code> constructor. These bounds will be transformed by any <code>AffineTransform</code> from
     * the <code>RenderContext</code>. The <code>RenderingHints</code> from the <code>RenderContext</code> may be used
     * to specify the tile width and height, <code>SampleModel</code>, and <code>ColorModel</code> by supplying an
     * <code>ImageLayout</code> hint. The precedence for determining tile width and height is to use firstly values
     * provided explicitly via the <code>ImageLayout</code>, secondly the width and height of the <code>SampleModel
     * </code> in the hint, and thirdly the bounds of the <code>RenderableGraphics</code> object after transformation.
     *
     * <p>If either the <code>SampleModel</code> or <code>ColorModel</code> is null, an attempt will be made to derive a
     * compatible value for the null object from the non-null object. If they are both null, a 3-band byte <code>
     * TiledImage</code> with a null <code>ColorModel</code> and a <code>PixelInterleavedSampleModel</code> will be
     * created.
     *
