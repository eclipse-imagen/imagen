...
public class DCTDescriptor extends OperationDescriptorImpl {
    ...
    public static RenderedOp create(RenderedImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("DCT", RenderedRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);

        return ImageN.create("DCT", pb, hints);
    }
    ...
    public static RenderableOp createRenderable(RenderableImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("DCT", RenderableRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);

        return ImageN.createRenderable("DCT", pb, hints);
    }
}
