...
public class IDFTDescriptor extends OperationDescriptorImpl {
    ...
    public static RenderedOp create(
        ...
        ParameterBlockJAI pb = new ParameterBlockJAI("IDFT", RenderedRegistryMode.MODE_NAME);
    ...
    public static RenderableOp createRenderable(
        ...
        ParameterBlockJAI pb = new ParameterBlockJAI("IDFT", RenderableRegistryMode.MODE_NAME);
