...
final class DilateBinaryOpImage extends AreaOpImage {
    ...
    /**
     * Creates a DilateBinaryOpImage given a ParameterBlock containing the image source and pre-rotated dilation kernel.
    ...
    protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect) {
        ...
        for (int j = 0; j < dheight; j++) {
            ...
            for (int i = 0; i < kw - 1; i++) {
                ...
                bitLoc = 7 - (bitLoc & 7);
                for (int m = 0, sOffsetB = sOffset; m < kh; m++, sOffsetB += srcIm.lineStride) {
