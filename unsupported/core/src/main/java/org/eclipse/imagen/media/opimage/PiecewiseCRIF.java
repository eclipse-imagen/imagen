...
/**
 * A <code>CRIF</code> supporting the "Piecewise" operation in the rendered and renderable image layers.
 *
...
public class PiecewiseCRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock args, RenderingHints renderHints) {
        ...
        return new PiecewiseOpImage(
                args.getRenderedSource(0), renderHints, layout, (float[][][]) args.getObjectParameter(0));
    }
}
