...
public class MagnitudeSquaredDescriptor extends OperationDescriptorImpl {
    ...
    public static RenderedOp create(RenderedImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("MagnitudeSquared", RenderedRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);

        return ImageN.create("MagnitudeSquared", pb, hints);
    }
    ...
    public static RenderableOp createRenderable(RenderableImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("MagnitudeSquared", RenderableRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);

        return ImageN.createRenderable("MagnitudeSquared", pb, hints);
    }
}
