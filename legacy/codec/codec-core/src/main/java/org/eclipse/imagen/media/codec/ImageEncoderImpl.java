...
public abstract class ImageEncoderImpl implements ImageEncoder {
    ...
    /**
     * Returns the current parameters as an instance of the ImageEncodeParam interface. Concrete implementations of this
     * interface will return corresponding concrete implementations of the ImageEncodeParam interface. For example, a
     * JPEGImageEncoder will return an instance of JPEGEncodeParam.
     */
    ...
    /**
     * Sets the current parameters to an instance of the ImageEncodeParam interface. Concrete implementations of
     * ImageEncoder may throw a RuntimeException if the params argument is not an instance of the appropriate subclass
     * or subinterface. For example, a JPEGImageEncoder will expect param to be an instance of JPEGEncodeParam.
     */
    ...
    /**
     * Encodes a Raster with a given ColorModel and writes the output to the OutputStream associated with this
     * ImageEncoder.
     */
