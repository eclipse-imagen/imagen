...
/**
 * This class is the descriptor for the "Raw" tile codec. The "Raw" tile codec scheme involves simply writing out the
 * raw pixel data to the encoded stream. The format name for the raw tile codec is "raw". Since the encoded stream
 * contains the <code>Raster</code>, it automatically contains the <code>SampleModel</code> and the tile's upper left
 * corner position. Therefore the <code>includesSampleModelInfo()</code> and <code>includesLocationInfo()</code> methods
 * in this descriptor return true.
 *
...
public class RawTileCodecDescriptor extends TileCodecDescriptorImpl {
     ...
     * </code> sufficient to decode that same tile. For the raw tile codec, no parameters are used. So null will be
     ...
     * </code>. For the raw tile codec, no parameters are used. So null will be returned for any valid modeName
     * specified.
     *
     * @param modeName The registry mode to return a valid parameter list for.
     * @throws IllegalArgumentException if <code>modeName</code> is null.
    ...
    /**
     * Returns the default parameters for the specified modeName as an instance of the <code>TileCodecParameterList
     * </code>, adding a "sampleModel" parameter with the specified value to the parameter list. For the raw tile codec,
     * no parameters is used. So null will be returned for any valid modeName specified.
     *
     ...
     *
     * <p>If a parameter named "sampleModel" exists in the default parameter list, the supplied SampleModel will
     * override the value associated with this default parameter.
     *
     * @param modeName The registry mode to return a valid parameter list for.
