...
/**
 * An <code>OpImage</code> implementing the "Min" operation as described in <code>
 * org.eclipse.imagen.operator.MinDescriptor</code>.
 *
 * <p>This <code>OpImage</code> chooses the minimum pixel values of the two source images on a per-band basis. In case
 ...
 * </pre>
 *
 * @see org.eclipse.imagen.operator.MinDescriptor
 * @see MinRIF
 */
final class MinOpImage extends PointOpImage {
    ...
    /**
     * Return the minimum pixel value of the source images for a specified rectangle.
     *
        ...
        for (int b = 0; b < bands; b++) {
            ...
            for (int h = 0; h < dheight; h++) {
                ...
                for (int w = 0; w < dwidth; w++) {
                    d[dPixelOffset] = minUShort(s1[s1PixelOffset], s2[s2PixelOffset]);
    ...
    private void computeRectShort(RasterAccessor src1, RasterAccessor src2, RasterAccessor dst) {
        ...
        for (int b = 0; b < bands; b++) {
            ...
            for (int h = 0; h < dheight; h++) {
                ...
                for (int w = 0; w < dwidth; w++) {
                    d[dPixelOffset] = minShort(s1[s1PixelOffset], s2[s2PixelOffset]);
    ...
    private void computeRectInt(RasterAccessor src1, RasterAccessor src2, RasterAccessor dst) {
        ...
        for (int b = 0; b < bands; b++) {
            ...
            for (int h = 0; h < dheight; h++) {
                ...
                for (int w = 0; w < dwidth; w++) {
                    d[dPixelOffset] = minInt(s1[s1PixelOffset], s2[s2PixelOffset]);
    ...
    private void computeRectFloat(RasterAccessor src1, RasterAccessor src2, RasterAccessor dst) {
        ...
        for (int b = 0; b < bands; b++) {
            ...
            for (int h = 0; h < dheight; h++) {
                ...
                for (int w = 0; w < dwidth; w++) {
                    d[dPixelOffset] = minFloat(s1[s1PixelOffset], s2[s2PixelOffset]);
    ...
    private void computeRectDouble(RasterAccessor src1, RasterAccessor src2, RasterAccessor dst) {
        ...
        for (int b = 0; b < bands; b++) {
            ...
            for (int h = 0; h < dheight; h++) {
                ...
                for (int w = 0; w < dwidth; w++) {
                    d[dPixelOffset] = minDouble(s1[s1PixelOffset], s2[s2PixelOffset]);
