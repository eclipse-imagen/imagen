...
/**
 * A <code>CRIF</code> supporting the "Divide" operation in the rendered and renderable image layers.
 *
 * @since EA2
...
public class DivideCRIF extends CRIFImpl {
    ...
    /**
     * Creates a new instance of <code>DivideOpImage</code> in the rendered layer. This method satisfies the
