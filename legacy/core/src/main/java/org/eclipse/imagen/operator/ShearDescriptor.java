 ...
 *
 * <p>The "Shear" operation shears an image either horizontally or vertically. For each pixel (x, y) of the destination,
 * the source value at the fractional subpixel position (x', y') is constructed by means of an Interpolation object and
 * written to the destination.
 *
 * <p>If the "shearDir" parameter is equal to SHEAR_HORIZONTAL then <code>x' = (x - xTrans - y*shear)</code> and <code>
 * y' = y</code>. If the "shearDir" parameter is equal to SHEAR_VERTICAL then <code>x' = x</code> and <code>
 * y' = (y - yTrans - x*shear)</code>.
 *
 ...
 *
 * <p>"Shear" defines a PropertyGenerator that performs an identical transformation on the "ROI" property of the source
 ...
 *                            <td>0.0F</td>
 * <tr><td>shearDir</td>      <td>org.eclipse.imagen.operator.ShearDir</td>
...
public class ShearDescriptor extends OperationDescriptorImpl {
    ...
    /**
     * The resource strings that provide the general documentation and specify the parameter list for the "Shear"
     * operation.
     */
    ...
    private static final String[] paramNames = {
        "shear", "shearDir", "xTrans", "yTrans", "interpolation", "backgroundValues"
    };
    ...
    /**
     * Returns an array of <code>PropertyGenerators</code> implementing property inheritance for the "Shear" operation.
     *
     ...
     * @param shearDir The shear direction. May be <code>null</code>.
    ...
    public static RenderedOp create(
        ...
        return ImageN.create("Shear", pb, hints);
    }
}
