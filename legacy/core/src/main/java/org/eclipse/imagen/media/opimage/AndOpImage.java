...
/**
 * An <code>OpImage</code> implementing the "And" operation as described in <code>
 * org.eclipse.imagen.operator.AndDescriptor</code>.
 *
 * <p>This <code>OpImage</code> logically "ands" the pixel values of two source images on a per-band basis. In case the
