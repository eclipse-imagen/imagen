 ...
 *
 * <p>The "Invert" operation inverts the pixel values of an image. For source images with signed data types, the pixel
 * values of the destination image are defined by the pseudocode:
 *
 ...
 *
 * where <code>MAX_VALUE</code> is the maximum value supported by the system of the data type of the source pixel.
 *
 * <p>
 *
 * <table border=1>
...
public class InvertDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[][] resources = {
        ...
        {
            "DocURL",
            "http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/InvertDescriptor.html"
        },
    ...
    public static RenderedOp create(RenderedImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("Invert", RenderedRegistryMode.MODE_NAME);
    ...
    public static RenderableOp createRenderable(RenderableImage source0, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("Invert", RenderableRegistryMode.MODE_NAME);
