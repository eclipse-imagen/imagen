...
/**
 * An <code>OpImage</code> implementing the "Exp" operation as described in <code>
 * org.eclipse.imagen.operator.ExpDescriptor</code>.
 *
 * <p>The result is rounded to the closest integer for intergral data types.
 *
 * <p>This <code>OpImage</code> takes the natural exponential of the pixel values of an image. The operation is done on
 * a per-pixel, per-band basis.
 *
...
final class ExpOpImage extends ColormapOpImage {
    ...
    /**
     * The largest unsigned short to get a non-overflowed exponential result. i.e. cloeset to 65536. exp(11) =
     * 59874.14171, exp(12) = 162754.7914
     */
    private static int USHORT_UP_BOUND = 11;

    /**
     * The largest short to get a non-overflowed exponential result. i.e. closest to 32767. exp(10) = 22026.46579,
     * exp(11) = 59874.14171
     */
    private static int SHORT_UP_BOUND = 10;

    /**
     * The largest int to get a non-overflown exponential result. i.e. cloeset to 2**31-1 = 2147483647. exp(21) =
     * 1318815734, exp(22) = 3584912846.
     */
    private static int INT_UP_BOUND = 21;

    /**
     * The smallest integer to get a non-zero exponential result is 0. i.e. exp(0) = 1; exp(-1) = 0.367879441, which
     * will be stored as 0. all other negative values will result in 0.
     */
     ...
     * Constructor.
     *
     * <p>The layout of the source is used as the fall-back for the layout of the destination. Any layout parameters not
     * specified in the <code>layout</code> argument are set to the same value as that of the source.
     *
