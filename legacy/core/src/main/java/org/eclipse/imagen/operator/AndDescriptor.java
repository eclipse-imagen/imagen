 ...
 *
 * <p>The And operation takes two source images, and performs a bit-wise logical "and" on every pair of pixels, one from
 * each source image, of the corresponding position and band. No additional parameters are required.
 *
...
public class AndDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[][] resources = {
        ...
        {
            "DocURL",
            "http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/AndDescriptor.html"
        },
    ...
    protected boolean validateSources(String modeName, ParameterBlock args, StringBuffer msg) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (dtype != DataBuffer.TYPE_BYTE
                ...
                msg.append(getName() + " " + JaiI18N.getString("AndDescriptor1"));
                return false;
            }
        }
    ...
    public static RenderedOp create(RenderedImage source0, RenderedImage source1, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("And", RenderedRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);
        pb.setSource("source1", source1);

        return ImageN.create("And", pb, hints);
    }
    ...
    public static RenderableOp createRenderable(
        ...
        ParameterBlockImageN pb = new ParameterBlockImageN("And", RenderableRegistryMode.MODE_NAME);

        pb.setSource("source0", source0);
        pb.setSource("source1", source1);

        return ImageN.createRenderable("And", pb, hints);
    }
}
