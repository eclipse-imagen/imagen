...
public class RotateCRIF extends CRIFImpl {
            ...
            if (((dangle % 90) == 0)
                ...
                if (layout == null) {
                    ...
                    OpImage intermediateImage =
                            new TranslateIntOpImage(trans, renderHints, rotMinX - imMinX, rotMinY - imMinY);
                    try {
    ...
    /**
     * Gets the bounding box for the output of <code>TranslateOpImage</code>. This method satisfies the implementation
     * of CRIF.
     */
    public Rectangle2D getBounds2D(ParameterBlock paramBlock) {
        ...
        if (dangle % 270 == 0) {
            if (dangle < 0) {
                ...
                tx1 = s_height - y0 - 1;
                ty1 = x1;
                return new Rectangle2D.Float(tx0, ty0, tx1 - tx0 + 1, ty1 - ty0 + 1);
            } else {
                // 270 degrees
                tx0 = y0;
                ty0 = s_width - x1 - 1;
