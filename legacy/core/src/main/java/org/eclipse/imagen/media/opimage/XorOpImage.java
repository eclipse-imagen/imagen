...
/**
 * An <code>OpImage</code> implementing the "Xor" operation as described in <code>
 * org.eclipse.imagen.operator.XorDescriptor</code>.
 *
 * <p>This <code>OpImage</code> logically "xors" the pixel values of two source images on a per-band basis. In case the
 * two source images have different number of bands, the number of bands for the destination image is the smaller band
...
final class XorOpImage extends PointOpImage {
    ...
    /**
     * Constructs an <code>XorOpImage</code>.
     *
     ...
     */
    public XorOpImage(RenderedImage source1, RenderedImage source2, Map config, ImageLayout layout) {
    ...
    /**
     * Xors the pixel values of two source images within a specified rectangle.
     *
    ...
    //         System.out.println("XorOpImage Test");
    //         ImageLayout layout;
    ...
    //         dst = new XorOpImage(src1, src2, null, null);
