...
/**
 * An <code>OperationDescriptor</code> describing the "MultiplyConst" operation.
 *
 * <p>The MultiplyConst operation takes one rendered or renderable image and an array of double constants, and
 * multiplies every pixel of the same band of the source by the constant from the corresponding array entry. If the
 * number of constants supplied is less than the number of bands of the destination, then the constant from entry 0 is
 * applied to all the bands. Otherwise, a constant from a different entry is applied to each band.
 *
 ...
 *
 * <p>The destination pixel values are calculated as: if (constants.length < dstNumBands) { dst[x][y][b] =
 * srcs[x][y][b]*constants[0]; } else { dst[x][y][b] = srcs[x][y][b]*constants[b]; } </pre>
 *
 * <p>
 *
 * <table border=1>
 ...
 * <tr><td>GlobalName</td>  <td>MultiplyConst</td></tr>
 * <tr><td>LocalName</td>   <td>MultiplyConst</td></tr>
 * <tr><td>Vendor</td>      <td>org.eclipse.imagen.media</td></tr>
 * <tr><td>Description</td> <td>Multiplies an image by
 *                              constants.</td></tr>
 * <tr><td>DocURL</td>      <td>http://java.sun.com/products/java-media/jai/forDevelopers/jai-apidocs/javax/media/jai/operator/MultiplyConstDescriptor.html</td></tr>
 * <tr><td>Version</td>     <td>1.0</td></tr>
 * <tr><td>arg0Desc</td>    <td>The constants to be multiplied.</td></tr>
 * </table>
 *
 * <p>
 *
...
public class MultiplyConstDescriptor extends OperationDescriptorImpl {
    ...
    private static final Object[] paramDefaults = {new double[] {1.0}};
     ...
     * @param constants The constants to be multiplied. May be <code>null</code>.
    ...
    public static RenderedOp create(RenderedImage source0, double[] constants, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("MultiplyConst", RenderedRegistryMode.MODE_NAME);
    ...
    public static RenderableOp createRenderable(RenderableImage source0, double[] constants, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("MultiplyConst", RenderableRegistryMode.MODE_NAME);
