...
public class RenderableRMIServerProxy implements RenderableImage {
    ...
    /**
     * Creates a <code>RenderableRMIServerProxy</code> to access the <code>RenderableOp</code> on the server identified
     * by the supplied <code>opID</code>.
     */
     ...
     * method may return an empty vector, to indicate that the image has no sources, or null, to indicate that no
     ...
     *
     * @return <code>true</code> if successive renderings with the same arguments might produce different results;
     ...
     *
     * @return the minimum Y coordinate of the rendering-independent image data.
     */
    ...
    /** Returns the ID that refers to the <code>RenderableOp</code> on the server. */
    ...
    /**
     * Returns a RenderedImage instance of this image with a default width and height in pixels. The RenderContext is
