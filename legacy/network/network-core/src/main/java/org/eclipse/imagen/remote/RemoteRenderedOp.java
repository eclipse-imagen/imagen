 ...
 * a <code>RemoteRenderedOp</code> will cause a <code>PropertyChangeEventImageN</code> detailing the change to be fired to
 * all registered <code>PropertyChangeListener</code>s. <code>RemoteRenderedOp</code> registers itself as a <code>
 * PropertyChangeListener</code> for all critical attributes, and thus receives all <code>PropertyChangeEventImageN</code>
 ...
 *
 * <p>When a <code>RemoteRenderedOp</code> node receives a <code>PropertyChangeEventImageN</code> from itself, the region
 ...
 * PropertyChangeEventImageN</code>. The identified tiles will be retained from the old rendering insofar as possible. This
...
public class RemoteRenderedOp extends RenderedOp implements RemoteRenderedImage {
     ...
     * rendered. The oldValue field in the <code>PropertyChangeEventImageN</code> will contain the old server name <code>
     ...
     * rendered. The oldValue field in the <code>PropertyChangeEventImageN</code> will contain the old protocol name <code>
     ...
     */
    private void newEventRendering(String protocolName, PlanarImageServerProxy oldPISP, PropertyChangeEventImageN event) {
