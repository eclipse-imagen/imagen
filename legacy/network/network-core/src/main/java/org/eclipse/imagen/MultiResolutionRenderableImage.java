...
public class MultiResolutionRenderableImage implements WritablePropertySource, RenderableImage, Serializable {
     ...
     * @throws IllegalArgumentException if the supplied height is non-positive.
     */
    ...
    /**
     * Returns a list of the properties recognized by this image. If no properties are recognized by this image, null
     ...
     * java.awt.Image.UndefinedProperty will be returned. The default implementation returns <code>
     * java.awt.Image.UndefinedProperty</code>.
     *
    ...
    /**
     * Removes the named property from the <code>MultiResolutionRenderableImage</code>.
     *
    ...
    /**
     * Returns false since successive renderings (that is, calls to createRendering() or createScaledRendering()) with
     * the same arguments will never produce different results.
     */
     ...
     *
     * @param renderContext a RenderContext describing the transform rendering hints.
    ...
    public RenderedImage createRendering(RenderContext renderContext) {
        ...
        if (type == AffineTransform.TYPE_UNIFORM_SCALE || type == AffineTransform.TYPE_GENERAL_SCALE) {
