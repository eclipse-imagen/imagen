...
/**
 * J-unit TestClass used for checking the functionalities of all the iterators. The tests called testRandomIterXXX
 * creates a RandomIter with 3 different data types and with 3 different RandomIter types:
 *
 * <ul>
 *   <li>With or without cached tiles.
 *   <li>With or without position array pre calculation (If this array is not calculated the tiles are always not
 *       cached).
 * </ul>
 *
...
public class RandomIterTest {
    ...
    public static void imagePreparation() {
        ...
        iterByteIMGFloat = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageByteIMGFloat, null);

        iterShortIMGFloat = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageShortIMGFloat, null);

        iterIntIMGFloat = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageIntIMGFloat, null);

        iterByteIMGDouble = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageByteIMGDouble, null);

        iterShortIMGDouble = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageShortIMGDouble, null);

        iterIntIMGDouble = org.eclipse.imagen.iterator.RandomIterFactory.create(testImageIntIMGDouble, null);
    ...
    public void testRandomIterFloat(
    ...
    public void testRandomIterDouble(
            RenderedImage img, double[] valueArray, boolean cachedTiles, boolean arrayCalculation) {
        RandomIter iter = RandomIterFactory.create(img, null, cachedTiles, arrayCalculation);
    ...
    public void testIteratorSpeed(
            RenderedImage img, boolean cachedTiles, boolean arrayCalculation, boolean subsequentIterator) {
        // RandomIter used
        RandomIter iter = RandomIterFactory.create(img, null, cachedTiles, arrayCalculation);
