...
public class RandomIterFallbackLocal implements RandomIter {
    ...
    public int getSample(int x, int y, int b) {
        ...
        return sampleModel.getSample(x - sampleModelTranslateX, y - sampleModelTranslateY, b, tile.getDataBuffer());
    }
    ...
    public float getSampleFloat(int x, int y, int b) {
        ...
        return sampleModel.getSampleFloat(
                x - sampleModelTranslateX, y - sampleModelTranslateY, b, tile.getDataBuffer());
    }
    ...
    public double getSampleDouble(int x, int y, int b) {
        ...
        return sampleModel.getSampleDouble(
                x - sampleModelTranslateX, y - sampleModelTranslateY, b, tile.getDataBuffer());
    }
    ...
    public int[] getPixel(int x, int y, int[] iArray) {
        ...
        return sampleModel.getPixel(x - sampleModelTranslateX, y - sampleModelTranslateY, iArray, tile.getDataBuffer());
    }
    ...
    public float[] getPixel(int x, int y, float[] fArray) {
        ...
        return sampleModel.getPixel(x - sampleModelTranslateX, y - sampleModelTranslateY, fArray, tile.getDataBuffer());
    }
    ...
    public double[] getPixel(int x, int y, double[] dArray) {
        ...
        return sampleModel.getPixel(x - sampleModelTranslateX, y - sampleModelTranslateY, dArray, tile.getDataBuffer());
    }
    ...
    /**
     * This class is used only by the threadLocal to store the value of the current tile used and its coordinates. By
     * using getters and setters all the inner parameters can be retrieved or changed
     */
