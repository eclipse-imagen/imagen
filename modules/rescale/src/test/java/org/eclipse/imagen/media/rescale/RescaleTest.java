...
/**
 * This test class is used for checking the functionalities of the Rescale operation on all the possible data types. The
 * various tests are performed by taking the destination image tile, and comparing it with the related source tile
 * pixels. The comparison is made by taking each source pixel, rescaling it and ensuring that it is equal to the
 ...
 *   <li>1 with ROI RasterAccessor and without NoData
 *   <li>2 with ROI and without NoData
 *   <li>3 with ROI RasterAccessor and with NoData
 *   <li>4 without ROI and with NoData
 *   <li>5 with ROI and NoData
 * </ul>
 */
public class RescaleTest extends TestBase {
    ...
    public void testRescale(
            RenderedImage source, boolean roiUsed, boolean noDataUsed, boolean useRoiAccessor, TestSelection select) {
