...
/**
 * This test class is used for compare the timing between the new and the old versions of the Crop descriptor . If the
 * user wants to change the number of the benchmark cycles or of the not benchmark cycles, should only pass the new
 * values to the JAI.Ext.BenchmarkCycles or JAI.Ext.NotBenchmarkCycles parameters. The selection of the old or new
 * descriptor must be done by setting to true or false the JVM parameter JAI.Ext.OldDescriptor. For the old descriptor
    ...
    public void testCrop() {
        ...
        for (int i = 0; i < totalCycles; i++) {
            ...
            if (OLD_DESCRIPTOR) {
                ...
                //                imageCrop = org.eclipse.imagen.operator.CropDescriptor.create(
                //                        image, cropX, cropY, cropWidth, cropHeight, null);
            } else {
                imageCrop = CropDescriptor.create(image, cropX, cropY, cropWidth, cropHeight, roi, range, null, null);
            }
