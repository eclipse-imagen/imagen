...
public class CropCRIF implements RenderedImageFactory {
     ...
     *
     * @param paramBlock parameter block with parameters minx, miny, width height
     * @param renderHints optional rendering hints which may be used to pass down a tile scheduler and tile cache
     */
