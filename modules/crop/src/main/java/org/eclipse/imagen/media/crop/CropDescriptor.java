...
public class CropDescriptor extends OperationDescriptorImpl {
    ...
    private static final Object[] paramDefaults = {
        Float.valueOf(0), Float.valueOf(0), NO_PARAMETER_DEFAULT, NO_PARAMETER_DEFAULT, null, null, new double[] {0}
    };
        ...
        try {
            ...
            if (opr.getDescriptor(RenderedRegistryMode.MODE_NAME, "Crop") == null) {
                ...
                registry.registerFactory(
                        RenderedRegistryMode.MODE_NAME, descName, "org.eclipse.imagen.media", new CropCRIF());
            }
        } catch (Exception e) {
