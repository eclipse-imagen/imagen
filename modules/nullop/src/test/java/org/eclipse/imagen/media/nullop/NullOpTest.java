...
public class NullOpTest extends TestBase {
    ...
    public static void initialSetup() {
        ...
        testImage[DataBuffer.TYPE_BYTE] =
                createTestImage(DataBuffer.TYPE_BYTE, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueB, false, 1);
        testImage[DataBuffer.TYPE_USHORT] =
                createTestImage(DataBuffer.TYPE_USHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueS, false, 1);
        testImage[DataBuffer.TYPE_SHORT] =
                createTestImage(DataBuffer.TYPE_SHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueS, false, 1);
        testImage[DataBuffer.TYPE_INT] =
                createTestImage(DataBuffer.TYPE_INT, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueI, false, 1);
        testImage[DataBuffer.TYPE_FLOAT] =
                createTestImage(DataBuffer.TYPE_FLOAT, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueF, false, 1);
        testImage[DataBuffer.TYPE_DOUBLE] =
                createTestImage(DataBuffer.TYPE_DOUBLE, DEFAULT_WIDTH, DEFAULT_HEIGHT, valueD, false, 1);
    ...
    /**
     * Test which performs the Null operation on the source image and checks if the image pixels of a single tile are
     * equals
     *
