 ...
 * non-image data via the use of <code>PropertyGenerator</code>s. Another use of this class is the possibility to put
 * this OpImage at the sink of a RenderedOp chain for caching the tiles of the last OpImage without caching the tiles of
...
public class NullCRIF extends CRIFImpl {
     ...
     * getSourcelessImage()</code> if there are no sources.
     *
