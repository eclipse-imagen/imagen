...
public class BandSelectDescriptor extends OperationDescriptorImpl {
    ...
    private static final Class<?>[] parametersClasses = {int[].class};

    /** The parameter name list for this operation. */
    private static final String[] parametersNames = {"bandIndices"};

    /** The parameter default value list for this operation. */
    private static final Object[] parametersDefaults = {NO_PARAMETER_DEFAULT};

    private static final String[] supportedModes = {"rendered", "renderable"};

    /** Constructor. */
    public BandSelectDescriptor() {
        super(resources, supportedModes, 1, parametersNames, parametersClasses, parametersDefaults, null);
    }
    ...
    public static RenderedOp create(RenderedImage source0, int[] bandIndices, RenderingHints hints) {
        ...
        return ImageN.create("BandSelect", pb, hints);
    }
    ...
    public static RenderableOp createRenderable(RenderableImage source0, int[] bandIndices, RenderingHints hints) {
        ...
        return ImageN.createRenderable("BandSelect", pb, hints);
    }
}
