...
import org.eclipse.imagen.media.lookup.LookupTableWrapper;
...
public class ColorIndexerTest extends TestBase {
    ...
    private RenderedImage quantize(RenderedImage image, ROI roi, Range nodata, int destNoData) {
        ...
        RenderedImage indexed = ColorIndexerDescriptor.create(image, indexer, roi, nodata, destNoData, null);
    ...
    public void testGrayColorNoData() {
        ...
        g.dispose();
        RenderedImage indexed = quantize(image, null, RangeFactory.create((byte) 255, (byte) 255), 1);
        assertTrue(indexed.getColorModel() instanceof IndexColorModel);
        IndexColorModel icm = (IndexColorModel) indexed.getColorModel();
    ...
    public void testTranslatedImageTileGridROINoData() {
        ...
        component = StatisticsDescriptor.create(component, 1, 1, null, null, false, new int[] {0}, stats, null);
    ...
    private RenderedImage forceComponentColorModel(RenderedImage image) {
        ...
        // Lookup Operations
        image = LookupDescriptor.create(image, new LookupTableWrapper(lut), 0, null, null, false, hints);
    ...
    public void testRegistration() {
        ...
        assertArrayEquals(new String[] {"Indexer", "roi", "nodata", "destNoData"}, parameters.getParamNames());
    }
}
