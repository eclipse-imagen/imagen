...
/**
 * Palette that re-uses the ColorMap used to build the palette itsel to speedup the lookups. When there is no shift
 * every color found in the map can be also found in the color map.
 *
