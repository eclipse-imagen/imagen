...
/**
 * {@link PointOpImage} to perform a color inversion given a certain {@link ColorIndexer}. Derived and improved from
 * GeoTools one
 *
...
public class ColorIndexerOpImage extends PointOpImage {
    ...
    public ColorIndexerOpImage(
            RenderedImage image, ColorIndexer palette, ROI roi, Range nodata, int destNoData, RenderingHints hints) {
