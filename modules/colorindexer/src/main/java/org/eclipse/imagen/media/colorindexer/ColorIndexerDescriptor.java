...
public class ColorIndexerDescriptor extends OperationDescriptorImpl {
    ...
    public ColorIndexerDescriptor() {
        super(
                new String[][] {
                    ...
                    {"Description", "Produce a paletted image from an RGB or RGBA image using a provided palette."},
    ...
    protected boolean validateParameters(
        ...
        if (!(param.getObjectParameter(0) instanceof ColorIndexer)) return false;
        return true;
    }
