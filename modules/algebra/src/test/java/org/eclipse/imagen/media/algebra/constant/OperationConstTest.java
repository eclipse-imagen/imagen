...
public class OperationConstTest extends TestBase {
    ...
    public static void initialSetup() {
        ...
        testImages[DataBuffer.TYPE_BYTE] =
                createTestImage(DataBuffer.TYPE_BYTE, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataB, false, 3);
        testImages[DataBuffer.TYPE_USHORT] = createTestImage(
                DataBuffer.TYPE_USHORT, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataS, false, 3);
        testImages[DataBuffer.TYPE_SHORT] = createTestImage(
                DataBuffer.TYPE_SHORT, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataS, false, 3);
        testImages[DataBuffer.TYPE_INT] =
                createTestImage(DataBuffer.TYPE_INT, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataI, false, 3);
        testImages[DataBuffer.TYPE_FLOAT] = createTestImage(
                DataBuffer.TYPE_FLOAT, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataF, false, 3);
        testImages[DataBuffer.TYPE_DOUBLE] = createTestImage(
                DataBuffer.TYPE_DOUBLE, DEFAULT_WIDTH_REDUCED, DEFAULT_HEIGHT_REDUCED, noDataD, false, 3);
        IMAGE_FILLER = false;
    ...
    private void testOperation(RenderedImage source, Operator op, boolean noDataUsed, boolean roiUsed) {
        ...
        RenderedOp calculated =
                OperationConstDescriptor.create(source, doubleConsts, op, roi, noData, destNoData, null);
        // Check
    ...
    private void testOperation(RenderedOp calculated, RenderedImage source, ROI roi, Range noData, Operator op) {
                    ...
                    if (isValidData) {
                        ...
                        switch (dataType) {
                            ...
                            case DataBuffer.TYPE_USHORT:
                                ...
                                //                            valueOld = ImageUtil.clampUShort(op.calculate(((int)
                                // sample & 0xFFFF),
                                //                                    (int) doubleConsts[b]));
                                break;
                            case DataBuffer.TYPE_SHORT:
                                valueOld = ImageUtil.clampRoundShort(valueOld);
                                //                            valueOld = ImageUtil.clampShort(op.calculate((short)
                                // sample,
                            ...
                            case DataBuffer.TYPE_FLOAT:
                                ...
                                //                            valueOld = ImageUtil.clampFloat(op.calculate((float)
                                // sample,
