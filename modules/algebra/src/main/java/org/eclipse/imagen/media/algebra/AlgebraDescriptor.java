...
public class AlgebraDescriptor extends OperationDescriptorImpl {
    ...
    public enum Operator {
        ...
        LOG(9, 0, false) {
            ...
            @Override
            public short calculate(boolean isUshort, short... values) {
                return (short) Math.log((isUshort ? values[0] & ImageUtil.USHORT_MASK : values[0]) + 0.5);
            }
        ...
        /**
         * The largest int to get a non-overflowed exponential result. i.e. closest to 2**31-1 = 2147483647. exp(21) =
    ...
    private static final String[][] resources = {
        ...
        {"DocURL", "Not Defined"},
        {"Version", "1.0"},
        {"arg0Desc", "Operation to execute"},
        {"arg1Desc", "ROI object used"},
        {"arg2Desc", "No Data Range used"},
        {"arg3Desc", "Output value for No Data"},
    };
    ...
    private static final Class[] paramClasses = {
        Operator.class, org.eclipse.imagen.ROI.class, org.eclipse.imagen.media.range.Range.class, Double.class
    };
