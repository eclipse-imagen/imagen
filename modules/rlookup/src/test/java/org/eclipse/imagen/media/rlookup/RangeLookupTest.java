...
public class RangeLookupTest extends TestBase {
    ...
    public static <T extends Number & Comparable<? super T>, U extends Number & Comparable<? super U>>
        ...
        for (int i = 1; i < N; i++) {
            r = RangeFactory.create(breaks[i - 1].doubleValue(), true, breaks[i].doubleValue(), false);
     ...
     */
    private void assertImageValues(
            RenderedImage srcImg, RangeLookupTable table, RenderedImage destImg, ROI roi, Double defaultValue) {
