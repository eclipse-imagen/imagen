...
public class RangeLookupRIF implements RenderedImageFactory {
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderHints) {
         ...
         */
        final Number defaultValue = (Number) paramBlock.getObjectParameter(RangeLookupDescriptor.DEFAULT_ARG);
        ...
        if (destClazz.equals(Short.class)) {
            ...
            try {
                ...
                throw new IllegalArgumentException(
                        "Illegal destination class for this rangelookuptable:" + destClazz.toString());
            }
        }
        ...
        if (isDataTypeChanged) {
            ...
            SampleModel csm =
                    RasterFactory.createComponentSampleModel(sampleModel, dataType, tileWidth, tileHeight, numBands);
            ...
            if (colorModel != null
                    && !JDKWorkarounds.areCompatibleDataModels(layout.getSampleModel(null), colorModel)) {
