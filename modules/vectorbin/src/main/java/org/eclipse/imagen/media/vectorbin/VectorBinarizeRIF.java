...
public class VectorBinarizeRIF implements RenderedImageFactory {
     ...
     * @param renderHints optional rendering hints which may be used to pass an {@code ImageLayout} object containing a
     *     {@code SampleModel} to use when creating destination tiles
     */
