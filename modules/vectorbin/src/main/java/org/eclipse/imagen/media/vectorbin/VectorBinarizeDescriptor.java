...
/**
 * Describes the "VectorBinarize" operation which creates a binary image based on pixel inclusion in a polygonal
...
public class VectorBinarizeDescriptor extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = {
        Integer.class, Integer.class, Integer.class, Integer.class, Object.class, Boolean.class
    };
    ...
    public VectorBinarizeDescriptor() {
        super(
                new String[][] {
                    ...
                    {
                        "Description",
                        "Creates a binary image based on the inclusion of " + "pixels within a polygonal Geometry"
                    },
                    {"DocURL", ""},
                    {"Version", "1.3.0"},
