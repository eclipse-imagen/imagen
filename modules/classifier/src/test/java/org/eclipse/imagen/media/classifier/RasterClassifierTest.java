...
public class RasterClassifierTest extends TestBase {
    ...
    public void testSyntheticDouble() throws IOException {
        ...
        for (int i = 0; i < TEST_NUM; i++) {
            ...
            // Operation creation
            final ParameterBlockImageN pbj = new ParameterBlockImageN(RasterClassifierOpImage.OPERATION_NAME);
            pbj.addSource(image);
    ...
    private LinearColorMap buildCategories() {
        ...
        final LinearColorMapElement c3 =
                LinearColorMapElement.create("c3", Color.green, RangeFactory.create(100.0f, false, 300.0f, true), 2);
    ...
    public void testSpearfish() throws IOException {
        ...
        for (int i = 0; i < TEST_NUM; i++) {
            final LinearColorMapElement c0 =
                    LinearColorMapElement.create("c0", Color.yellow, RangeFactory.create(0, true, 11, true), 5);

            final LinearColorMapElement c1 =
                    LinearColorMapElement.create("c2", Color.blue, RangeFactory.create(11, false, 12, true), 1);

            final LinearColorMapElement c3 =
                    LinearColorMapElement.create("c3", Color.green, RangeFactory.create(12, false, 14, true), 7);

            final LinearColorMapElement c4 =
                    LinearColorMapElement.create("c4", Color.blue, RangeFactory.create(14, false, 16, true), 1);

            final LinearColorMapElement c5 =
                    LinearColorMapElement.create("c4", Color.CYAN, RangeFactory.create(16, false, 255, false), 11);

            final LinearColorMapElement c6 =
                    LinearColorMapElement.create("nodata", new Color(0, 0, 0, 0), RangeFactory.create(255, 255), 0);
    ...
    public void testInvalidColorMap() throws IOException {
        ...
        final LinearColorMapElement c0 =
                LinearColorMapElement.create("c0", Color.green, RangeFactory.create(Double.NEGATIVE_INFINITY, 0.3), 51);
        ...
        // rouge element
        final LinearColorMapElement c4 = LinearColorMapElement.create(
                "c4", Color.BLUE, RangeFactory.create(0.2, false, Double.POSITIVE_INFINITY, true), 3);
