...
public class RasterClassifierDescriptor extends OperationDescriptorImpl {
    ...
    public RasterClassifierDescriptor() {
        super(
                new String[][] {
                    {"GlobalName", RasterClassifierOpImage.OPERATION_NAME},
                ...
                1,
                new String[] {"Domain1D", "bandIndex", "roi", "nodata"}, // Argument names
                new Class[] {
     ...
     * source image is equals to the number of supplied sample dimensions, and that all sample dimensions has pieces.
     *
    ...
    public RenderedOp create(
        ...
        ParameterBlockImageN pb =
                new ParameterBlockImageN(RasterClassifierOpImage.OPERATION_NAME, RenderedRegistryMode.MODE_NAME);
        // Setting source
        ...
        return ImageN.create(RasterClassifierOpImage.OPERATION_NAME, pb, hints);
    }
}
