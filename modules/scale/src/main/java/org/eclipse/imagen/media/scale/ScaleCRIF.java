...
public class ScaleCRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderHints) {
        ...
        if (nearestInterp && isBinary) {
            return new org.eclipse.imagen.media.scale.ScaleGeneralOpImage(
                    source,
                    layout,
                    renderHints,
                    extender,
            ...
            return new org.eclipse.imagen.media.scale.ScaleNearestOpImage(
                    source,
                    layout,
                    renderHints,
                    extender,
            ...
            return new org.eclipse.imagen.media.scale.ScaleBilinearOpImage(
                    source,
                    layout,
                    renderHints,
                    extender,
            ...
            return new org.eclipse.imagen.media.scale.ScaleBicubicOpImage(
                    source,
                    layout,
                    renderHints,
                    extender,
