...
public class TestScale extends TestBase {
    ...
    protected void testImage(
            ...
            ScaleType scaleValue,
            Number noDataValue) {
        RenderedImage sourceImage = createTestImage(dataType, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataValue, isBinary);
    ...
    protected void testImage(
        ...
        RenderedImage destinationIMG = testAndReturnImage(
                dataType,
                noDataValue,
                useROIAccessor,
                isBinary,
    ...
    protected RenderedImage testAndReturnImage(
            int dataType,
            Number noDataValue,
            boolean useROIAccessor,
            boolean isBinary,
