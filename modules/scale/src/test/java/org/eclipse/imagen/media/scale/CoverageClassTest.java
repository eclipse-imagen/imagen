...
public class CoverageClassTest extends TestScale {
    ...
    public void testROIProperty() throws IOException {
        ...
        ScalePropertyGenerator propertyGenerator =
                (ScalePropertyGenerator) descriptor.getPropertyGenerators()[0];
        ...
        // Scaled images
        RenderedImage scaleImgNear = ScaleDescriptor.create(
                testIMG, scaleX, scaleY, transX, transY, interpNear, roi, useROIAccessor, null, null, null);

        RenderedImage scaleImgBil = ScaleDescriptor.create(
                testIMG, scaleX, scaleY, transX, transY, interpBil, roi, useROIAccessor, null, null, null);

        RenderedImage scaleImgBic = ScaleDescriptor.create(
                testIMG, scaleX, scaleY, transX, transY, interpBic, roi, useROIAccessor, null, null, null);
    ...
    public void testTranslation(
        ...
        // Scaled images
        RenderedOp scaleImgNear = ScaleDescriptor.create(
    ...
    public void testCopy() {
        ...
        // Scaled images
        PlanarImage scaleImgNear = ScaleDescriptor.create(
