 ...
 * ParameterBlock, RenderingHints. The first one stores all the mosaic parameters, the second stores eventual hints used
 * for changing the image settings. The only one method of this class returns a new instance of the MosaicOpImage
 * operation.
 */
public class MosaicRIF implements RenderedImageFactory {

    /**
     * This method implements the RenderedImageFactory create method and return the MosaicOpImage using the parameters
