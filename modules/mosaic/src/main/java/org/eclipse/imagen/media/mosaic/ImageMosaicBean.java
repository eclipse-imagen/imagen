...
/**
 * This class implements a Java Bean used as input values container of the for the MosaicOpImage2 class. Inside this
 * class are contained the following values:
 *
 * <ul>
 *   <li>The input image
 *   <li>an eventual alpha channel
 *   <li>an eventual ROI
 *   <li>an eventual Range of No Data values
 * </ul>
 *
 * The all class methods are getters and setters of all the private variables. The constructor is parameterless and the
 * class implements the Serializable interface. These characteristics are fundamental for creating a Java Bean.
 */
