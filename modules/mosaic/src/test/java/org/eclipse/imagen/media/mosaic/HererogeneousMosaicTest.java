...
import static org.eclipse.imagen.media.testclasses.TestBase.createTestImage;
...
public class HererogeneousMosaicTest {
    ...
    public void testBGRIndexed() {
        ...
        RenderedOp redIndexedTranslated =
                TranslateDescriptor.create(redIndexed, 50f, 0f, new InterpolationNearest(), null);
    ...
    public void testRGBGray() {
        ...
        RenderedOp blueRgbTranslated = TranslateDescriptor.create(blueRgb, 50f, 0f, new InterpolationNearest(), null);
    ...
    public void testIndexedGray() {
        ...
        RenderedOp blueIndexedTranslated =
                TranslateDescriptor.create(blueIndexed, 50f, 0f, new InterpolationNearest(), null);
        BufferedImage gray = buildByteGray(Color.GRAY);
    ...
    public void testGrayByteShort() {
        ...
        RenderedOp whiteTranslated = TranslateDescriptor.create(white, 50f, 0f, new InterpolationNearest(), null);
    ...
    public void testGrayShortRGB() {
        ...
        RenderedOp grayTranslated = TranslateDescriptor.create(gray, 50f, 0f, new InterpolationNearest(), null);
    ...
    public void testEteroPalettes() {
        ...
        BufferedImage whiteIndexed = buildIndexed(Color.WHITE, Color.GRAY, Color.GREEN, Color.WHITE);
        RenderedOp blueIndexedTranslated =
                TranslateDescriptor.create(blueIndexed, 50f, 0f, new InterpolationNearest(), null);
    ...
    private void assertFloatDouble(BiFunction<RenderedOp, RenderedImage, RenderedOp> mosaicImages) {
        RenderedImage zeroFloat = createTestImage(DataBuffer.TYPE_FLOAT, 100, 100, null, false, 1, 0f);
        RenderedOp zeroFloatTranslated =
                TranslateDescriptor.create(zeroFloat, 50f, 0f, new InterpolationNearest(), null);
        RenderedImage oneDouble = createTestImage(DataBuffer.TYPE_DOUBLE, 100, 100, null, false, 1, 1d);
    ...
    public void testSamePalettes() {
        BufferedImage blueIndexed = buildIndexed(Color.BLUE, Color.BLUE, Color.GREEN, Color.WHITE);
        BufferedImage greenIndexed = buildIndexed(Color.GREEN, Color.BLUE, Color.GREEN, Color.WHITE);
        RenderedOp blueIndexedTranslated =
                TranslateDescriptor.create(blueIndexed, 50f, 0f, new InterpolationNearest(), null);
    ...
    public void testIndexedNoDataRBG() {
        ...
        RenderedOp mosaic = MosaicDescriptor.create(
                ...
                null,
                null,
                new Range[] {RangeFactory.create((byte) 0, (byte) 0), null},
                null);
    ...
    public void testTwoIndexedNoSameNoData() {
        // build an indexed image, Blue for the first 50 px, red for the other 50
        IndexColorModel icm = buildIndexColorModel(Color.BLUE, Color.RED);
        BufferedImage splitVertical = new BufferedImage(100, 100, BufferedImage.TYPE_BYTE_INDEXED, icm);
        ...
        BufferedImage splitHorizontal = new BufferedImage(100, 100, BufferedImage.TYPE_BYTE_INDEXED, icm);
        ...
        RenderedOp mosaic = MosaicDescriptor.create(
                ...
                null,
                new double[] {0, 0, 0},
                new Range[] {noDataBlue, noDataRed},
                null);
    ...
    public void testTwoIndexedSameNoData() {
        ...
        RenderedOp mosaic = MosaicDescriptor.create(
                ...
                null,
                null,
                new Range[] {noDataBlue, noDataBlue},
                null);
    ...
    private RenderedImage buildByteGrayAlpha(Color color) {
        ComponentColorModel colorModel = new ComponentColorModel(
                ColorSpace.getInstance(ColorSpace.CS_GRAY), true, false, ColorModel.TRANSLUCENT, DataBuffer.TYPE_BYTE);
