 ...
 *
 * <p>This operation is able to check if each input pixel is contained inside the provided ROI and if it is not a NoData
 * value. If a pixel in the kernel is outside ROI or a NoData, the related Kernel value is not calculated and
 * destination No Data value is returned.
 *
...
public class ConvolveDescriptor extends OperationDescriptorImpl {
    ...
    private static final Object[] paramDefaults = {NO_PARAMETER_DEFAULT, null, null, 0d, true};
     ...
     * @param destNoData Double value used for setting destination No Data value when it is not possible to calculate
