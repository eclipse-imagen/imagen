            ...
            for (int k = 0; k < dnumBands; k++) {
                ...
                for (int j = 0; j < dheight; j++) {
                    ...
                    for (int i = 0; i < dwidth; i++) {
                        ...
                        if (skipNoData) {
                            isValid = lut[b0] && lut[b1] && lut[b2] && lut[b3] && lut[b4] && lut[b5] && lut[b6]
                                    && lut[b7] && lut[b8];
                        }
            ...
            for (int k = 0; k < dnumBands; k++) {
                ...
                for (int j = 0; j < dheight; j++) {
                    ...
                    for (int i = 0; i < dwidth; i++) {
                        ...
                        float f =
                                k0 * s0 + k1 * s1 + k2 * s2 + k3 * s3 + k4 * s4 + k5 * s5 + k6 * s6 + k7 * s7 + k8 * s8;
            ...
            for (int k = 0; k < dnumBands; k++) {
                ...
                for (int j = 0; j < dheight; j++) {
                    ...
                    for (int i = 0; i < dwidth; i++) {
                        ...
                        // Check if nodata must be skipped
                        if (skipNoData) {
                            isValid = !(nod0 || nod1 || nod2 || nod3 || nod4 || nod5 || nod6 || nod7 || nod8);
                        }
                        // NoData Check
                        if (isValid) {
                            float f = k0 * (nod0 ? 0 : s0)
                                    + k1 * (nod1 ? 0 : s1)
                                    + k2 * (nod2 ? 0 : s2)
                                    + k3 * (nod3 ? 0 : s3)
                                    + k4 * (nod4 ? 0 : s4)
