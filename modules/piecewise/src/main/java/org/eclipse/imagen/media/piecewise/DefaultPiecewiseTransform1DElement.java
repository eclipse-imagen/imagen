...
public class DefaultPiecewiseTransform1DElement extends DefaultDomainElement1D implements PiecewiseTransform1DElement {
    ...
    public static DefaultPiecewiseTransform1DElement create(
            final CharSequence name, final Range inRange, final double value) {
     ...
     */
    public static DefaultPiecewiseTransform1DElement create(
            final CharSequence name, final Range inRange, final byte value) {
        return new DefaultConstantPiecewiseTransformElement(name, inRange, value);
    }
     ...
     */
    public static DefaultPiecewiseTransform1DElement create(
            final CharSequence name, final Range inRange, final int value) {
        return new DefaultConstantPiecewiseTransformElement(name, inRange, value);
    }
     ...
     */
    public static DefaultPiecewiseTransform1DElement create(
            final CharSequence name, final Range inRange, final Range outRange) {
     ...
     */
    public static DefaultPiecewiseTransform1DElement create(final CharSequence name) throws IllegalArgumentException {
        return new DefaultPassthroughPiecewiseTransform1DElement(
                name, RangeFactory.create(Double.NEGATIVE_INFINITY, true, Double.POSITIVE_INFINITY, true, true));
    }
     ...
     * @throws IllegalArgumentException
     */
    public static DefaultPiecewiseTransform1DElement create(final CharSequence name, final Range valueRange)
            throws IllegalArgumentException {
    ...
    /**
     * Public constructor for building a {@link DomainElement1D} which applies the specified transformation on the
     * values that fall into its definition range.
     *
     * @param name for this {@link DomainElement1D}.
     * @param valueRange for this {@link DomainElement1D}.
     ...
     * @throws IllegalArgumentException
     */
    public DefaultPiecewiseTransform1DElement(CharSequence name, Range valueRange, final MathTransformation transform)
            throws IllegalArgumentException {
        super(name, valueRange);
        // /////////////////////////////////////////////////////////////////////
        //
    ...
    public synchronized double transform(double value) throws TransformationException {
        ...
        if (contains(value)) return transform.transform(value);
    ...
    protected synchronized void setInverse(MathTransformation mathTransform) {
        if (this.inverse == null) this.inverse = mathTransform;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DefaultPiecewiseTransform1DElement)) return false;
        ...
        if (!PiecewiseUtilities.equals(transform, that.transform)) return false;
        if (!PiecewiseUtilities.equals(inverse, that.inverse)) return false;
    ...
    public static DefaultPiecewiseTransform1DElement create(
            String string, Range range, MathTransformation mathTransform1D) {
