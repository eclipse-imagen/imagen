...
public interface PiecewiseTransform1D<T extends PiecewiseTransform1DElement> extends Domain1D<T> {
    ...
    /**
     * Indicates whether or not this {@link PiecewiseTransform1D} has a default value which will be returned when asked
     * to transform a value outside the valid domain elements.
     *
     ...
     *
     * <p>In case {@link #hasDefaultValue()} return <code>false</code> this value has no meaning.
     *
     * @return The default value which will be returned when asked to transform a value outside the valid domain
     *     elements.
     */
