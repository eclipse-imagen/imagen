 ...
 *
 * <p>All {@link DomainElement1D}D <strong>must</strong> have a human readable name.
 *
 * <p>All {@code DomainElement1D} objects are immutable and thread-safe.
 *
...
public interface DomainElement1D extends Serializable, Comparable<DomainElement1D> {
     ...
     *
     * @param value to check for the inclusion.
     * @return <code>true</code> if the {@link NumberRange} belongs to this {@link DomainElement1D}, <code>false</code>
     *     otherwise.
     */
