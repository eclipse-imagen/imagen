...
public class GenericPiecewiseOpImage<T extends PiecewiseTransform1DElement> extends ColormapOpImage {
     ...
     */
    public GenericPiecewiseOpImage(
    ...
    private void computeRectGeneral(
            final Raster source,
            final WritableRaster dest,
            final Rectangle destRect,
            RandomIter roiIter,
                        ...
                        do {
                            ...
                            if (!dstIter.finishedPixels() && !srcIter.finishedPixels())
                                do {
                                    ...
                                    //
                                    // //
                                    if (element != null) dstIter.setSample(element.transform(value));
                                    else {
                                        // //
                                        //
                                        ...
                                        //
                                        // //
                                        if (hasGapsValue) dstIter.setSample(gapsValue);
                                        else
                                            // //
                                            //
                                ...
                                do {
                                    if (!(roiBounds.contains(x0, y0) && roiIter.getSample(x0, y0, 0) > 0)) {
                                        ...
                                        if (element != null) dstIter.setSample(element.transform(value));
                                            ...
                                            if (hasGapsValue) dstIter.setSample(gapsValue);
                                            else throw new IllegalArgumentException("Unable to set input Gap value");
                                        }
                                    }
                                    x0++;
                                } while (!dstIter.nextPixelDone() && !srcIter.nextPixelDone());
            ...
            for (int value = 0; value < 256; value++) {
                ...
                if (useLast) {
                    if (lastPiecewiseElement != null && lastPiecewiseElement.contains(value))
                        ...
                        lastPiecewiseElement =
                                piecewiseElement = (PiecewiseTransform1DElement) piecewise.findDomainElement(value);
                    }
