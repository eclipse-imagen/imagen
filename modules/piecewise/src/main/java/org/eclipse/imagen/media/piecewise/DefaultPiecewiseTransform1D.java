...
/**
 * Convenience implementation of the {@link PiecewiseTransform1D} interface which subclass the {@link DefaultDomain1D}
 * class in order to provide a suitable framework to handle a list of {@link PiecewiseTransform1DElement} s.
 *
 * <p>
 *
...
public class DefaultPiecewiseTransform1D<T extends DefaultPiecewiseTransform1DElement> extends DefaultDomain1D<T>
    ...
    public double transform(final double value) throws TransformationException {
        ...
        if (piece == null) {
            ...
            if (hasDefaultValue()) return getDefaultValue();
    ...
    public boolean equals(Object object) {
        if ((object instanceof DefaultPiecewiseTransform1D)) {
            ...
            if (this.hasDefaultValue != that.hasDefaultValue) return false;
