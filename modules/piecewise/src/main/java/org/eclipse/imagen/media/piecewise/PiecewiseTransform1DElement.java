...
/**
 * This interface extends the {@link DomainElement1D} interface in order to add the capabilities to perform 1D
 * transformations on its values. Note that to do so it also extends the OGC {@link MathTransformation} interface.
 *
