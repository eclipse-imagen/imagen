...
public class TestPiecewise extends TestBase {
    ...
    public void linearTransform() throws IOException, TransformationException {
        ...
        DefaultPiecewiseTransform1DElement e0 = DefaultPiecewiseTransform1DElement.create(
                "zero", RangeFactory.create(0, true, 100, true), RangeFactory.create(0, true, 200, true));
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform = new DefaultPiecewiseTransform1D<
                DefaultPiecewiseTransform1DElement>(new DefaultPiecewiseTransform1DElement[] {e0});
    ...
    public void constantTransform() throws IOException, TransformationException {
        ...
        DefaultPiecewiseTransform1DElement e0 = DefaultPiecewiseTransform1DElement.create(
                "zero",
                RangeFactory.create(Double.NEGATIVE_INFINITY, true, Double.POSITIVE_INFINITY, true, true),
                ((byte) 0));
        ...
        e0 = DefaultPiecewiseTransform1DElement.create(
                "zero", RangeFactory.create(Double.NEGATIVE_INFINITY, true, Double.POSITIVE_INFINITY, true, true), 0);
        Assert.assertTrue(e0 instanceof DefaultConstantPiecewiseTransformElement);
        // checks
        Assert.assertEquals(0.0, e0.transform(0), 0.0);
        Assert.assertEquals(e0.transform(Double.POSITIVE_INFINITY), 0.0, 0.0);

        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform1 = new DefaultPiecewiseTransform1D<
                DefaultPiecewiseTransform1DElement>(new DefaultPiecewiseTransform1DElement[] {e0});
        ...
        // /////////////////////////////////////////////////////////////////////
        e0 = DefaultPiecewiseTransform1DElement.create(
                "zero", RangeFactory.create(Double.NEGATIVE_INFINITY, true, Double.POSITIVE_INFINITY, true, true), 0.0);
        Assert.assertTrue(e0 instanceof DefaultConstantPiecewiseTransformElement);
        // checks
        Assert.assertEquals(0.0, e0.transform(0), 0.0);
        Assert.assertEquals(e0.transform(Double.POSITIVE_INFINITY), 0.0, 0.0);
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        e0 = DefaultPiecewiseTransform1DElement.create("zero", RangeFactory.create(3, true, 3, true), 0.0);
        Assert.assertTrue(e0 instanceof DefaultConstantPiecewiseTransformElement);
        // checks
    ...
    public void piecewiseLogarithm() throws IOException, TransformationException {
        ...
        final DefaultPiecewiseTransform1DElement zero =
                DefaultPiecewiseTransform1DElement.create("zero", RangeFactory.create(0, true, 0, true), 0);
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform = new DefaultPiecewiseTransform1D<
                DefaultPiecewiseTransform1DElement>(new DefaultPiecewiseTransform1DElement[] {zero, mainElement});
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        final DefaultPiecewiseTransform1DElement nodata = DefaultPiecewiseTransform1DElement.create(
                "no-data", RangeFactory.create(-1, true, -1, true), Double.NaN);
        transform = new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        final DefaultPiecewiseTransform1DElement overlap = DefaultPiecewiseTransform1DElement.create(
                "overlap", RangeFactory.create(-100, true, 12, true), Double.NaN);
        try {
            transform = new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(
    ...
    public void defaultTransform() throws IOException, TransformationException {
        ...
        DefaultPiecewiseTransform1DElement t0 = new DefaultPiecewiseTransform1DElement(
                ...
                PiecewiseUtilities.createLinearTransform1D(
                        RangeFactory.create(0.0, true, 1.0, true, false), RangeFactory.create(200, true, 201, true)));
        ...
        t0 = DefaultPiecewiseTransform1DElement.create(
                "t0", RangeFactory.create(0.0, true, 1.0, true, false), RangeFactory.create(200, true, 201, true));
        Assert.assertFalse(t0.equals(DefaultPiecewiseTransform1DElement.create(
                "t0", RangeFactory.create(0.0, true, 1.0, true, false), RangeFactory.create(200, true, 202, true))));
        Assert.assertEquals(t0.transform(0.5), 200.5, 0.0);
        Assert.assertEquals(t0.inverse().transform(200.5), 0.5, 0.0);
        ...
        DefaultPiecewiseTransform1DElement t1 =
                DefaultPiecewiseTransform1DElement.create("t1", RangeFactory.create(1.0, false, 2.0, true, false), 201);
        ...
        t1 = new DefaultConstantPiecewiseTransformElement("t1", RangeFactory.create(1.0, false, 2.0, true, false), 201);
        Assert.assertEquals(t1.transform(1.5), 201, 0.0);
        Assert.assertEquals(t1.transform(1.6), 201, 0.0);
        Assert.assertEquals(t1.transform(1.8), 201, 0.0);

        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform = new DefaultPiecewiseTransform1D<
                DefaultPiecewiseTransform1DElement>(new DefaultPiecewiseTransform1DElement[] {t1}, 12);
            ...
            transform = new DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement>(
                    new DefaultPiecewiseTransform1DElement[] {
                        DefaultLinearPiecewiseTransform1DElement.create(
                                "",
                                RangeFactory.create(0, true, 100, true),
                                RangeFactory.create(
                                        Double.NEGATIVE_INFINITY, true, Double.POSITIVE_INFINITY, true, false))
                    });
    ...
    public void lookupByteData() throws IOException, TransformationException {
        ...
        //
        // /////////////////////////////////////////////////////////////////////
        RenderedImage image = ImageN.create("ImageRead", TestData.file(this, "test.tif"));
        ...
        finalImage = ImageN.create(GenericPiecewiseOpImage.OPERATION_NAME, pbj);
        if (INTERACTIVE) {
            RenderedImageBrowser.showChain(finalImage, false, false, null);
        } else {
            finalImage.getTiles();
    ...
    public void logarithmicTransform() throws IOException {
        ImageN.getDefaultInstance().getTileScheduler().setParallelism(1);
        // /////////////////////////////////////////////////////////////////////
        //
        //
        // /////////////////////////////////////////////////////////////////////
        RenderedOp image = ImageN.create("ImageRead", TestData.file(this, "test.tif"));
        image = BandSelectDescriptor.create(image, new int[] {0}, null);
        image = FormatDescriptor.create(image, DataBuffer.TYPE_DOUBLE, null);
        ...
        image = StatisticsDescriptor.create(image, 1, 1, null, null, false, new int[] {0}, stats, null);
        ...
        final DefaultPiecewiseTransform1DElement mainElement = new DefaultPiecewiseTransform1DElement(
                "natural logarithm", RangeFactory.create(minimum, true, maximum, true), new MathTransformation() {
        ...
        DefaultPiecewiseTransform1D<DefaultPiecewiseTransform1DElement> transform = new DefaultPiecewiseTransform1D<
                DefaultPiecewiseTransform1DElement>(new DefaultPiecewiseTransform1DElement[] {mainElement}, 0);
        ...
        finalImage = ImageN.create(GenericPiecewiseOpImage.OPERATION_NAME, pbj, null);
        if (INTERACTIVE) {
            RenderedImageBrowser.showChain(finalImage, false, false, null);
        } else {
            finalImage.getTiles();
