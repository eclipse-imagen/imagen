...
public class ShadedReliefDescriptor extends OperationDescriptorImpl {
    ...
    /**
     * The resource strings that provide the general documentation and specify the parameter list for a ShadedRelief
     * operation.
     */
    ...
    private static final String[] paramNames = {
        "roi", "srcNoData", "dstNoData", "resX", "resY", "zetaFactor", "scale", "altitude", "azimuth", "algorithm"
    };
    ...
    /**
     * Returns an array of <code>PropertyGenerators</code> implementing property inheritance for the "ShadedRelief"
     * operation.
     *
    ...
    /**
     * @param altitude is the sun's angle of elevation above the horizon and ranges from 0 to 90 degrees. A value of 0
     *     degrees indicates that the sun is on the horizon, that is, on the same horizontal plane as the frame of
     *     reference. A value of 90 degrees indicates that the sun is directly overhead.
     * @param azimuth is the sun's relative position along the horizon (in degrees). This position is indicated by the
     *     angle of the sun measured clockwise from due north. An azimuth of 0 degrees indicates north, east is 90
