...
package org.eclipse.imagen.media.shadedrelief.cli;
...
public class ShadedReliefCommand extends AbstractCommand {
    ...
    private static Options createOptions() {
        ...
        options.addOption(Option.builder(OPT_SRCFILE)
                .longOpt("in")
                .hasArg()
                .argName("file")
                .desc("Input file")
                .required()
                .build());
        options.addOption(Option.builder(OPT_OUTFILE)
                .longOpt("out")
                .hasArg()
                .argName("file")
                .desc("Output file")
                .required()
                .build());
        options.addOption(Option.builder(OPT_SRCNODATA)
                .longOpt("srcnodata")
                .hasArg()
                .argName("val")
                .desc("Value of nodata in source file")
                .build());
        options.addOption(Option.builder(OPT_DSTNODATA)
                .longOpt("dstnodata")
                .hasArg()
                .argName("val")
                .desc("Value of nodata in out file")
                .build());
        options.addOption(Option.builder(OPT_RESX)
                .longOpt("resx")
                .hasArg()
                .argName("val")
                .desc("X resolutions")
                .build());
        options.addOption(Option.builder(OPT_RESY)
                .longOpt("resy")
                .hasArg()
                .argName("val")
                .desc("Y resolution")
                .build());
        options.addOption(Option.builder(OPT_ZETA)
                .longOpt("zeta")
                .hasArg()
                .argName("val")
                .desc("Vertical relief factor (exaggeration)")
                .build());
        options.addOption(Option.builder(OPT_SCALE)
                .longOpt("scale")
                .hasArg()
                .argName("val")
                .desc("Elevation unit to 2D unit scale ratio")
                .build());
        options.addOption(Option.builder(OPT_ALT)
                .longOpt("alt")
                .hasArg()
                .argName("val")
                .desc("Sun altitude")
                .build());
        options.addOption(Option.builder(OPT_AZ)
                .longOpt("azimuth")
                .hasArg()
                .argName("val")
                .desc("Sun azimuth")
                .build());
        options.addOption(Option.builder(OPT_ALG)
                .longOpt("algorithm")
                .hasArg()
                .argName("algorithm")
                .desc("Algorithm. May be ZT, ZTC, C")
                .build());
