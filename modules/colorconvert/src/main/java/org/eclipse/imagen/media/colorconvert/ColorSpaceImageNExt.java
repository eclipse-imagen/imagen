...
public abstract class ColorSpaceImageNExt extends ColorSpaceImageN {
    ...
    private static void RGBToCIEXYZByte(
        ...
        double[] destNoDataFinal = getConvertedNodataB(isInt, destNodata, normr, normg, normb, normx, normy, normz);
    ...
    private static void RGBToCIEXYZShort(
        ...
        double[] destNoDataFinal =
                getConvertedNodata(isInt, destNodata, DataBuffer.TYPE_SHORT, normr, normg, normb, normx, normy, normz);
    ...
    private static void RGBToCIEXYZInt(
        ...
        double[] destNoDataFinal =
                getConvertedNodata(isInt, destNodata, DataBuffer.TYPE_INT, normr, normg, normb, normx, normy, normz);
    ...
    private static void RGBToCIEXYZFloat(
        ...
        double[] destNoDataFinal =
                getConvertedNodata(isInt, destNodata, DataBuffer.TYPE_FLOAT, 0, 0, 0, normx, normy, normz);
        ...
        if (!hasNodata && (!hasROI || hasROI && roiContainsTile)) {
            ...
            for (int j = 0;
                ...
                for (int i = 0, rIndex = rStart, gIndex = gStart, bIndex = bStart;
                    ...
                    boolean notValid = nodata.contains(RGB[0]) || nodata.contains(RGB[1]) || nodata.contains(RGB[2]);
    ...
    private static void RGBToCIEXYZDouble(
        ...
        double[] destNoDataFinal =
                getConvertedNodata(isInt, destNodata, DataBuffer.TYPE_DOUBLE, 0, 0, 0, normx, normy, normz);
            ...
            for (int j = 0;
                ...
                for (int i = 0, rIndex = rStart, gIndex = gStart, bIndex = bStart;
                    ...
                    boolean notValid = nodata.contains(rBuf[rIndex])
                            || nodata.contains(gBuf[gIndex])
                            || nodata.contains(bBuf[bIndex]);
    ...
    private static void CIEXYZToRGBByte(
            UnpackedImageData src,
            int[] srcComponentSize,
            WritableRaster dest,
            int[] destComponentSize,
        ...
        double[] destNoDataFinal =
                getConvertedNodataCIEXYZ(destNodata, DataBuffer.TYPE_BYTE, upperr, upperg, upperb, normx, normy, normz);
        ...
        if (!hasNodata && (!hasROI || hasROI && roiContainsTile)) {
            for (int j = 0;
                    j < height;
                    j++, xStart += srcLineStride, yStart += srcLineStride, zStart += srcLineStride) {
            ...
            for (int j = 0;
                ...
                for (int i = 0, xIndex = xStart, yIndex = yStart, zIndex = zStart;
                    ...
                    boolean notValid = nodata.contains(x) || nodata.contains(y) || nodata.contains(z);
    ...
    private static void CIEXYZToRGBShort(
        ...
        double[] destNoDataFinal = getConvertedNodataCIEXYZ(
                destNodata, DataBuffer.TYPE_SHORT, upperr, upperg, upperb, normx, normy, normz);
    ...
    private static void CIEXYZToRGBFloat(
        ...
        double[] destNoDataFinal =
                getConvertedNodataCIEXYZ(destNodata, DataBuffer.TYPE_FLOAT, upperr, upperg, upperb, 0, 0, 0);
        ...
        if (!hasNodata && (!hasROI || hasROI && roiContainsTile)) {
            ...
            for (int j = 0;
                ...
                for (int i = 0, xIndex = xStart, yIndex = yStart, zIndex = zStart;
                    ...
                    boolean notValid = nodata.contains(XYZ[0]) || nodata.contains(XYZ[0]) || nodata.contains(XYZ[0]);
    ...
    private static void CIEXYZToRGBDouble(
        ...
        double[] destNoDataFinal =
                getConvertedNodataCIEXYZ(destNodata, DataBuffer.TYPE_DOUBLE, upperr, upperg, upperb, 0, 0, 0);
            ...
            for (int j = 0;
                ...
                for (int i = 0, xIndex = xStart, yIndex = yStart, zIndex = zStart;
                    ...
                    boolean notValid = nodata.contains(xBuf[xIndex])
                            || nodata.contains(yBuf[yIndex])
                            || nodata.contains(zBuf[zIndex]);
    ...
    private static double[] getConvertedNodataB(
            boolean isInt,
            float[] destNodata,
            int normr,
            int normg,
    ...
    private static double[] getConvertedNodata(
            boolean isInt,
            float[] destNodata,
            int dataType,
            double normr,
    ...
    private static double[] getConvertedNodataCIEXYZ(
            float[] destNodata,
            int dataType,
            double upperr,
            double upperg,
