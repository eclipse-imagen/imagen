...
/**
 * Test class used for comparing the JAI ColorConvert operation with the JAI-EXT one. Users may define how many
...
public class ComparisonTest extends TestBase {
    ...
    public static void init() {
        ...
        colorModel = new ComponentColorModel(cs, false, false, Transparency.OPAQUE, DataBuffer.TYPE_BYTE);
    }
