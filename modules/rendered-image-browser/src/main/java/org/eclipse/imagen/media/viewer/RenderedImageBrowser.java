 ...
 * various information on the selected {@link RenderedImage}
 *
 * @author Andrea Aime
...
public class RenderedImageBrowser extends JPanel {
    ...
    public static void showChain(
            RenderedImage image, final boolean showHistogram, final boolean showRoi, final String title) {
    ...
    public RenderedImageBrowser(final boolean showHistogram, final boolean showRoi) {
        ...
        imageTree.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                RenderedImage image =
                        (RenderedImage) imageTree.getSelectionPath().getLastPathComponent();
