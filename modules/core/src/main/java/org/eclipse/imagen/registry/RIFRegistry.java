...
/**
 * Utility class to provide type-safe interaction with the <code>OperationRegistry</code> for <code>RenderedImageFactory
 * </code> objects.
 *
...
public final class RIFRegistry {
     ...
     * @throws IllegalArgumentException if operationName, productName, or rif is <code>null</code>
     ...
     * @throws IllegalArgumentException if there is no <code>
     *             OperationDescriptor</code> registered against the <code>operationName</code>
     * @throws IllegalArgumentException if the rif was not previously registered against operationName and productName
     */
     ...
     * @throws IllegalArgumentException if operationName, productName, preferredRIF or otherRIF is <code>null</code>
     * @throws IllegalArgumentException if there is no <code>
     *             OperationDescriptor</code> registered against the <code>operationName</code>
     * @throws IllegalArgumentException if either of the rifs were not previously registered against operationName and
     *     productName
     */
     ...
     * RenderedImageFactory</code> objects registered under the operation name over all products. The order of objects
    ...
    /**
     * Returns the the most preferred <code>RenderedImageFactory</code> object registered against the operation name.
    ...
    /**
     * Constructs a <code>RenderedImage</code> (usually a <code>RenderedOp</code>) representing the results of applying
     * a given operation to a particular ParameterBlock and rendering hints. The registry is used to determine the RIF
