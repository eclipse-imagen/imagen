...
/**
 * This interface provides a comprehensive description of a specific image operation. All information regarding the
 * operation, such as its name, version, input, and properties should be listed. Any conditions placed on the operation,
 * such as its source class types and legal parameter range, should also be included, and the methods to enforce these
 ...
 *
 * <ul>
 *   <li>A global operation name that is visible to all and is the same in all <code>Locale</code>s.
 *   <li>A localized operation name that may be used as a synonym for the global operation name.
 *   <li>The name of the vendor defining this operation.
 *   <li>A brief description of this operation.
 *   <li>An URL where additional documentation on this operation may be found.
 *   <li>The version of this operation.
 * </ul>
 *
 * Additional information must be provided when appropriate. Only then can this operation be added to an <code>
 ...
 * same across all modes. The class types of the sources and parameters can be different for each mode.
 *
 * <p>For example an operation supporting the "rendered" mode takes <code>RenderedImage</code>s as its sources, can only
 * be used in a rendered operation chain, and produces a <code>RenderedImage</code>. An operation supporting the
...
public interface OperationDescriptor extends RegistryElementDescriptor {
    ...
    /**
     * An <code>Object</code> that signifies that a parameter has no default value. Same as <code>
    ...
    /**
     * Returns the resource data for this operation in the specified <code>Locale</code>. It must contain <code>String
     * </code> data for the following tags:
     *
     * <ul>
     *   <li>"GlobalName" - A global operation name that is visible to all and is the same in all <code>Locale</code>s.
     *   <li>"LocalName" - A localized operation name that may be used as a synonym for the "GlobalName".
     *   <li>"Vendor" - The name of the vendor defining this operation. Vendors are encouraged to use the Java
     *       convention of reversed Internet addresses.
     *   <li>"Description" - A brief description of this operation.
     *   <li>"DocURL" - An URL where additional documentation on this operation may be found.
     *   <li>"Version" - A free-form version indicator of this operation.
     * </ul>
     *
     * In addition, it may contain <code>String</code> data for the following tags when appropriate:
     *
     * <ul>
     *   <li>"arg0Desc", "arg1Desc", ... - Description of the input parameters.
     *   <li>"hint0Desc", hint1Desc", ... - Description of the rendering hints.
     * </ul>
     *
     * @param locale The <code>Locale</code> for which the information should be localized. It may be different from the
    ...
    /**
     * Returns the resource data for this operation in the specified <code>Locale</code> in a <code>ResourceBundle
     * </code>. The resource data values are taken from the <code>getResources()</code> method which must be implemented
     * by each operation descriptor.
     *
     * @param locale The <code>Locale</code> for which the information should be localized. It may be different from the
     *     default <code>Locale</code>.
     * @return A <code>ResourceBundle</code> containing the mandatory and optional resource information.
     */
     ...
     *     <code>null</code> if there is no common region of validity. If an empty <code>java.awt.Shape</code> is
     *     returned, this indicates that all pixels within the bounds of the old rendering remain valid.
     * @throws IllegalArgumentException if <code>registryModeName</code> is <code>null</code> or if the operation
     *     requires either sources or parameters and either <code>oldParamBlock</code> or <code>newParamBlock</code> is
     *     <code>null</code>.
    ...
    /**
     * Returns an array of <code>PropertyGenerator</code>s implementing the property inheritance for this operation.
     * They may be used as a basis for the operation's property management.
     *
    ...
    /**
     * Returns <code>true</code> if this operation is capable of handling the input rendered source(s) and/or
     * parameter(s) specified in the <code>ParameterBlock</code>, or <code>false</code> otherwise, in which case an
    ...
    /**
     * Returns <code>true</code> if this operation is capable of handling the input renderable source(s) and/or
     * parameter(s) specified in the <code>ParameterBlock</code>, or <code>false</code> otherwise, in which case an
     * explanatory message may be appended to the <code>StringBuffer</code>.
     *
     * <p>This method is the standard place where input arguments are validated against this operation's specification
    ...
    /**
     * Returns an array of <code>Object</code>s that define the default values of the parameters for this operation.
     * Default values may be <code>null</code>. When instantiating the operation, the default values may be used for
     * those parameters whose values are not supplied. The <code>NO_PARAMETER_DEFAULT</code> static <code>Object</code>
    ...
    /**
     * Returns the default value of a specified parameter. The default value may be <code>null</code>. If a parameter
     * has no default value, this method returns <code>NO_PARAMETER_DEFAULT</code>.
     *
     ...
     *
     * <p>The return value should be of the class type appropriate for the parameter's type, that is, <code>Byte</code>
     * for a <code>byte</code> parameter, <code>Integer</code> for an <code>int</code> parameter, and so forth.
     *
     * @param index The index of the numeric parameter whose minimum value is queried.
     * @return A <code>Number</code> representing the minimum legal value of the queried parameter, or <code>null</code>
     *     .
     * @throws NullPointerException if this operation has no parameter.
     * @throws ArrayIndexOutOfBoundsException if there is no parameter corresponding to the specified <code>index</code>
     *     .
     ...
     * for a <code>byte</code> parameter, <code>Integer</code> for an <code>int</code> parameter, and so forth.
     *
     * @param index The index of the numeric parameter whose maximum value is queried.
     * @return A <code>Number</code> representing the maximum legal value of the queried parameter, or <code>null</code>
     *     .
     * @throws NullPointerException if this operation has no parameter.
     * @throws ArrayIndexOutOfBoundsException if there is no parameter corresponding to the specified <code>index</code>
     *     .
