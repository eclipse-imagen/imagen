...
final class MedianFilterXOpImage extends MedianFilterOpImage {
    ...
    /**
     * Creates a MedianFilterXOpImage with the given source and maskSize. The image dimensions are derived from the
        ...
        for (int k = 0; k < dnumBands; k++) {
            ...
            for (int j = 0; j < dheight; j++) {
                ...
                for (int i = 0; i < dwidth; i++) {
                    ...
                    // twice when we do the second line
                    valueCount--;
    ...
    //         return new MedianFilterXOpImage(oit.getSource(), null, null,
