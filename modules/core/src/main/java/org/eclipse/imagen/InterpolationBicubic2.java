 ...
 *
 * <p>InterpolationBicubic2 is a subclass of Interpolation that performs interpolation using the piecewise cubic
 * polynomial:
 *
 * <pre>
 ...
 * with 'a' set to -1.0.
 *
 * <p>This definition is also sometimes known as "cubic convolution", using the parameter 'a' recommended by Keys. This
 * interpolator may produce somewhat sharper results than InterpolationBicubic, but that result is image dependent.
...
public final class InterpolationBicubic2 extends InterpolationTable {
    ...
    /**
     * Constructs an InterpolationBicubic2 with a given subsample precision, in bits. This precision is applied to both
     * axes.
     *
     * <p>This implementation creates an <code>InterpolationTable</code> whose integer coefficients have eight bits of
     * precision to the right of the binary point.
