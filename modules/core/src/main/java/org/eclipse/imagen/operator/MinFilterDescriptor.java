 ...
 *
 * <p>The "MinFilter" operation is a non-linear filter which is useful for removing isolated lines or pixels while
 ...
 *
 * <p>There are several shapes possible for the mask. The MinFilter operation supports three shapes, as follows:
 *
 * <p>Square Mask:
 *
 * <pre>
 ...
 * <tr><td>DocURL</td>      <td>http://java.sun.com/products/java-media/jai/forDevelopers/jaiapi/org.eclipse.imagen.operator.MinFilterDescriptor.html</td></tr>
 ...
 * <tr><td>maskShape</td> <td>org.eclipse.imagen.operator.MinFilterShape</td>
...
public class MinFilterDescriptor extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = {MinFilterShape.class, java.lang.Integer.class};
    ...
    /**
     * Returns an array of <code>PropertyGenerators</code> implementing property inheritance for the "MinFilter"
     * operation.
     *
     ...
     * @param maskShape The shape of the mask to be used for Min Filtering. May be <code>null</code>.
     * @param maskSize The size (width/height) of the mask to be used in Min Filtering. May be <code>null</code>.
     * @param hints The <code>RenderingHints</code> to use. May be <code>null</code>.
     * @return The <code>RenderedOp</code> destination.
     * @throws IllegalArgumentException if <code>source0</code> is <code>null</code>.
     */
    public static RenderedOp create(
            RenderedImage source0, MinFilterShape maskShape, Integer maskSize, RenderingHints hints) {
        ParameterBlockImageN pb = new ParameterBlockImageN("MinFilter", RenderedRegistryMode.MODE_NAME);
