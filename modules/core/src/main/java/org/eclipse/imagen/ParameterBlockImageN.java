 ...
 *
 * <p>All parameter names are treated in a case-insensitive but retentive manner.
 *
...
public class ParameterBlockImageN extends ParameterBlock implements ParameterList {
    ...
    /**
     * A <code>CaselessStringArrayTable</code> of parameter indices hashed by <code>CaselessStringKey</code> versions of
     * the parameter names.
     */
    private CaselessStringArrayTable paramIndices;

    /**
     * A <code>CaselessStringArrayTable</code> source indices hashed by <code>CaselessStringKey</code> versions of the
     * source names.
     */
     ...
     *
     * @throws IllegalStateException if the param value is <code>ParameterListDescriptor.NO_PARAMETER_DEFAULT</code>
     */
    ...
    /**
     * Gets a named parameter as an Object. Parameters belonging to a primitive type, such as <code>int</code>, will be
     * returned as a member of the corresponding <code>Number</code> subclass, such as <code>Integer</code>.
     *
    ...
    /**
     * A convenience method to return a parameter as a <code>byte</code>. An exception will be thrown if the parameter
    ...
    /**
     * A convenience method to return a parameter as a <code>boolean</code>. An exception will be thrown if the
    ...
    /**
     * A convenience method to return a parameter as a <code>char</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * A convenience method to return a parameter as an <code>short</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * A convenience method to return a parameter as an <code>int</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * A convenience method to return a parameter as a <code>long</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * A convenience method to return a parameter as a <code>float</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * A convenience method to return a parameter as a <code>double</code>. An exception will be thrown if the parameter
     * is of a different type.
     *
     * @param paramName the name of the parameter to be returned.
     * @throws IllegalArgumentException if there is no parameter with the specified name.
    ...
    /**
     * Sets a named parameter to a <code>byte</code> value. Checks are made to verify that the parameter is of the right
    ...
    /**
     * Sets a named parameter to a <code>boolean</code> value. Checks are made to verify that the parameter is of the
     * right <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to a <code>char</code> value. Checks are made to verify that the parameter is of the right
     * <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to a <code>short</code> value. Checks are made to verify that the parameter is of the
     * right <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to an <code>int</code> value. Checks are made to verify that the parameter is of the right
     * <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to a <code>long</code> value. Checks are made to verify that the parameter is of the right
     * <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to a <code>float</code> value. Checks are made to verify that the parameter is of the
     * right <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to a <code>double</code> value. Checks are made to verify that the parameter is of the
     * right <code>Class</code> type and that the value is valid.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to an <code>Object</code> value. The value may be <code>null</code>, an instance of the
     * class expected for this parameter, or a <code>DeferredData</code> instance the <code>getDataClass()</code> method
     * of which returns the expected class. If the object is a <code>DeferredData</code> instance, then its wrapped data
     * value is checked for validity if and only if its <code>isValid()</code> method returns <code>true</code>. If the
     * object is not a <code>DeferredData</code> instance, then it is always checked for validity.
     *
     * @param paramName a <code>String</code> naming a parameter.
    ...
    /**
     * Sets a named parameter to an Object value. The value may be <code>null</code>, an instance of the class expected
     * for this parameter, or a <code>DeferredData</code> instance the <code>getDataClass()</code> method of which
     * returns the expected class. If the object is a <code>DeferredData</code> instance, then its wrapped data value is
     * checked for validity if and only if its <code>isValid()</code> method returns <code>true</code>. If the object is
     * not a <code>DeferredData</code> instance, then it is always checked for validity.
     *
     * @param paramName a <code>String</code> naming a parameter.
     * @param obj an Object value for the parameter.
     * @throws IllegalArgumentException if paramName is null.
     ...
     * @throws ArrayIndexOutOfBoundsException if <code>index</code> is negative or not less than the number of
    ...
    /**
     * Sets the entire <code>Vector</code> of parameters to a given <code>Vector</code>. The <code>Vector</code> is
     * saved by reference.
     *
     * @throws IllegalArgumentException if the size of the supplied <code>Vector</code> does not equal the number of
     *     parameters of the associated operation.
     * @throws IllegalArgumentException if a non-<code>null</code>, non-<code>DeferredData</code> value is not an
     *     instance of the class expected for the indicated parameter or if <code>obj</code> is an invalid value for the
     *     indicated parameter.
     ...
     * @param paramName a <code>String</code> naming a parameter.
     * @param obj an Object value for the parameter.
     * @throws IllegalArgumentException if obj is null, or if the class type of obj does not match the class type of
     ...
     *     the deserialized operation name.
     */
