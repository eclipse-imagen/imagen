...
/** @since EA2 */
public final class WritableRandomIterCSMByte extends RandomIterCSMByte implements WritableRandomIter {

    public WritableRandomIterCSMByte(WritableRenderedImage im, Rectangle bounds) {
        super(im, bounds);
    }
