...
/**
 * A <code>CRIF</code> supporting the "Rescale" operation in the rendered and renderable image layers.
 *
...
public class RescaleCRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock args, RenderingHints renderHints) {
        ...
        return new RescaleOpImage(
                args.getRenderedSource(0), renderHints, layout, (double[]) args.getObjectParameter(0), (double[])
                        args.getObjectParameter(1));
    }
}
