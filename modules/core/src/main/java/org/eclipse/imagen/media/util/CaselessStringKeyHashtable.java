...
public class CaselessStringKeyHashtable extends Hashtable implements Cloneable, java.io.Serializable {
    ...
    /** Returns a clone of the <code>CaselessStringKeyHashtable</code> as an <code>Object</code>. */
    public Object clone() {
        return super.clone();
    }

    /**
     * Tests if the specified <code>String</code> is a key in this hashtable. The key is wrapped by a <code>
     * CaselessStringKey</code> before being looked up.
     *
    ...
    /**
     * Tests if the specified <code>CaselessStringKey</code> is a key in this hashtable.
     *
     * @param key possible key.
     * @return <code>true</code> if and only if the specified object is a key in this hashtable, as determined by the
     *     <tt>equals</tt> method; <code>false</code> otherwise.
    ...
    /**
     * Allow only <code>String</code> and <code>CaselessStringKey</code> keys to be looked up. This always throws an
    ...
    /**
     * Returns the value to which the specified key is mapped in this hashtable. The key is wrapped by a <code>
     * CaselessStringKey</code> before being looked up.
     *
    ...
    /**
     * Maps the specified <code>key</code> to the specified <code>value</code> in this hashtable. Neither the key nor
     * the value can be <code>null</code>. The key is wrapped by a <code>CaselessStringKey</code> before mapping the key
     * to the value.
     *
     ...
     * @exception IllegalArgumentException if the key or value is <code>null</code>.
    ...
    /**
     * Removes the key (and its corresponding value) from this hashtable. This method does nothing if the key is not in
     * the hashtable. The key is wrapped by a <code>CaselessStringKey</code> before trying to remove the entry.
     *
