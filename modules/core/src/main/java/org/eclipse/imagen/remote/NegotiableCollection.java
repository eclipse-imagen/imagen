...
public class NegotiableCollection implements Negotiable {
    ...
    /**
     * Creates a <code>NegotiableCollection</code> given an <code>Collection</code>.
     *
     * @throws IllegalArgumentException if collection is null.
     * @throws IllegalArgumentException if all the elements of collection are not of the same <code>Class</code> type.
     */
    ...
    /**
     * Creates a <code>NegotiableCollection</code> given an array of <code>Object</code>s. The elements of the <code>
     * Object</code> array are treated as being the elements of an <code>Collection</code>.
     *
     * @throws IllegalArgumentException if objects is null.
     * @throws IllegalArgumentException if all the elements of objects are not of the same <code>Class</code> type.
     */
    ...
    /**
     * Returns the <code>Collection</code> of values which are currently valid for this class, null if there are no
     * valid values.
     */
    ...
    /**
     * Returns a <code>NegotiableCollection</code> that contains those elements that are common to this <code>
     * NegotiableCollection</code> and the one supplied. If the supplied <code>Negotiable</code> is not a <code>
     * NegotiableCollection</code> with its elements being of the same <code>Class</code> as this class', or if there
     * are no common elements, the negotiation will fail and <code>null</code> (signifying the failure of the
     * negotiation) will be returned.
     *
    ...
    /**
     * Returns a single value that is valid for this <code>NegotiableCollection</code>. The returned value is the first
     * element contained in this <code>NegotiableCollection</code>. Returns <code>null</code> if there are no valid
     * elements in this <code>NegotiableCollection</code>.
     */
    ...
    /**
     * Returns the <code>Class</code> of the Object returned as the result of the negotiation. If the <code>Collection
     * </code> used to construct this <code>NegotiableCollection</code> was empty, i.e. had no elements, the <code>Class
     * </code> of the elements is indeterminate, therefore null will be returned from this method in such a case.
     */
