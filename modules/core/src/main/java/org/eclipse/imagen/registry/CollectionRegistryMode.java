...
public class CollectionRegistryMode extends RegistryMode {
    ...
    private static Method getThisFactoryMethod() {
        ...
        Class factoryClass = org.eclipse.imagen.CollectionImageFactory.class;
    ...
    /**
     * Constructor. A <code>RegistryMode</code> that represents a <code>CollectionImageFactory</code> keyed by
     * "collection"
     */
