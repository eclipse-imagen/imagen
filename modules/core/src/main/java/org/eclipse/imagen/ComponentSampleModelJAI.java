 ...
 * <code>DataBuffer</code>. It stores the N samples which make up a pixel in N separate data array elements. Different
 * bands may be in different banks of the <code>DataBuffer</code>. Accessor methods are provided so that image data can
 * be manipulated directly. This class can support different kinds of interleaving, e.g. band interleaving, scanline
 * interleaving, and pixel interleaving. Pixel stride is the number of data array elements between two samples for the
 * same band on the same scanline. Scanline stride is the number of data array elements between a given sample and the
 * corresponding sample in the same column of the next scanline. Band offsets denote the number of data array elements
 * from the first data array element of the bank of the <code>DataBuffer</code> holding each band to the first sample of
 * the band. The bands are numbered from 0 to N-1. This class can represent image data for the dataTypes enumerated in
 * java.awt.image.DataBuffer (all samples of a given <code>ComponentSampleModel</code> are stored with the same
 * precision) . This class adds support for <code>Double</code> and <code>Float</code> data types in addition to those
 * supported by the <code>ComponentSampleModel</code> class in Java 2D. All strides and offsets must be non-negative.
 *
...
public class ComponentSampleModelJAI extends ComponentSampleModel {
     ...
     * by the length of the bandOffsets array. All bands will be stored in the first bank of the <code>DataBuffer</code>
     * .
     *
    ...
    /**
     * Constructs a <code>ComponentSampleModel</code> with the specified parameters. The number of bands will be given
     * by the length of the bandOffsets array. Different bands may be stored in different banks of the <code>DataBuffer
     * </code>.
     *
     * @param dataType The data type for storing samples.
     * @param w The width (in pixels) of the region of image data described.
    ...
    /**
     * Returns the size of the data buffer (in data elements) needed for a data buffer that matches this <code>
    ...
    /**
     * Creates a new <code>ComponentSampleModel</code> with the specified width and height. The new <code>SampleModel
     * </code> will have the same number of bands, storage data type, interleaving scheme, and pixel stride as this
    ...
    /**
     * This creates a new <code>ComponentSampleModel</code> with a subset of the bands of this <code>
     * ComponentSampleModel</code>. The new <code>ComponentSampleModel</code> can be used with any <code>DataBuffer
     * </code> that the existing <code>ComponentSampleModel</code> can be used with. The new <code>ComponentSampleModel
     * </code>/<code>DataBuffer</code> combination will represent an image with a subset of the bands of the original
    ...
    /**
     * Creates a <code>DataBuffer</code> that corresponds to this <code>ComponentSampleModel</code>. The <code>
     * DataBuffer</code>'s data type, number of banks, and size will be consistent with this <code>ComponentSampleModel
     * </code>.
     */
    ...
    /**
     * Returns data for a single pixel in a primitive array of type TransferType. For a <code>ComponentSampleModel
     * </code>, this will be the same as the data type, and samples will be returned one per array element. Generally,
     * obj should be passed in as null, so that the <code>Object</code> will be created automatically and will be of the
     * right primitive data type.
     *
     * <p>The following code illustrates transferring data for one pixel from <code>DataBuffer</code> <code>db1</code>,
     * whose storage layout is described by <code>ComponentSampleModel</code> <code>csm1</code>, to <code>DataBuffer
     * </code> <code>db2</code>, whose storage layout is described by <code>ComponentSampleModel</code> <code>csm2
     * </code>. The transfer will generally be more efficient than using getPixel/setPixel.
     *
     * <pre>
     ...
     * </pre>
     *
     * Using getDataElements/setDataElements to transfer between two <code>DataBuffer</code>/SampleModel pairs is
     * legitimate if the <code>SampleModel</code>s have the same number of bands, corresponding bands have the same
    ...
    public Object getDataElements(int x, int y, Object obj, DataBuffer data) {
        ...
        switch (type) {
            case DataBuffer.TYPE_BYTE:
                ...
                if (obj == null) bdata = new byte[numDataElems];
                else bdata = (byte[]) obj;
            ...
            case DataBuffer.TYPE_USHORT:
                ...
                if (obj == null) usdata = new short[numDataElems];
                else usdata = (short[]) obj;
            ...
            case DataBuffer.TYPE_INT:
                ...
                if (obj == null) idata = new int[numDataElems];
                else idata = (int[]) obj;
            ...
            case DataBuffer.TYPE_SHORT:
                ...
                if (obj == null) sdata = new short[numDataElems];
            ...
            case DataBuffer.TYPE_FLOAT:
                ...
                if (obj == null) fdata = new float[numDataElems];
            ...
            case DataBuffer.TYPE_DOUBLE:
                ...
                if (obj == null) ddata = new double[numDataElems];
    ...
    /**
     * Returns the pixel data for the specified rectangle of pixels in a primitive array of type TransferType. For image
     * data supported by the Java 2D API, this will be one of the dataTypes supported by java.awt.image.DataBuffer. Data
     * may be returned in a packed format, thus increasing efficiency for data transfers. Generally, obj should be
     * passed in as null, so that the <code>Object</code> will be created automatically and will be of the right
     * primitive data type.
     *
     * <p>The following code illustrates transferring data for a rectangular region of pixels from <code>DataBuffer
     * </code> <code>db1</code>, whose storage layout is described by <code>SampleModel</code> <code>sm1</code>, to
     * <code>DataBuffer</code> <code>db2</code>, whose storage layout is described by <code>SampleModel</code> <code>sm2
     * </code>. The transfer will generally be more efficient than using getPixels/setPixels.
     *
     * <pre>
     *       SampleModel sm1, sm2;
     *       DataBuffer db1, db2;
    ...
    public Object getDataElements(int x, int y, int w, int h, Object obj, DataBuffer data) {
        ...
        switch (type) {
            ...
            case DataBuffer.TYPE_USHORT: {
                ...
                if (obj == null) usdata = new short[numDataElems * w * h];
                else usdata = (short[]) obj;
    ...
    /**
     * Sets the data for a single pixel in the specified <code>DataBuffer</code> from a primitive array of type
     * TransferType. For a <code>ComponentSampleModel</code>, this will be the same as the data type, and samples are
     * transferred one per array element.
     *
     * <p>The following code illustrates transferring data for one pixel from <code>DataBuffer</code> <code>db1</code>,
     * whose storage layout is described by <code>ComponentSampleModel</code> <code>csm1</code>, to <code>DataBuffer
     * </code> <code>db2</code>, whose storage layout is described by <code>ComponentSampleModel</code> <code>csm2
    ...
    /**
     * Sets the data for a rectangle of pixels in the specified <code>DataBuffer</code> from a primitive array of type
     * TransferType. For image data supported by the Java 2D API, this will be one of the dataTypes supported by
     * java.awt.image.DataBuffer. Data in the array may be in a packed format, thus increasing efficiency for data
     * transfers.
     *
     * <p>The following code illustrates transferring data for a rectangular region of pixels from <code>DataBuffer
     * </code> <code>db1</code>, whose storage layout is described by <code>SampleModel</code> <code>sm1</code>, to
    ...
    /**
     * Sets a sample in the specified band for the pixel located at (x,y) in the <code>DataBuffer</code> using a <code>
     * float</code> for input. <code>ArrayIndexOutOfBoundsException</code> may be thrown if the coordinates are not in
     * bounds.
     *
     * @param x The X coordinate of the pixel location.
     * @param y The Y coordinate of the pixel location.
     ...
     * ArrayIndexOutOfBoundsException</code> may be thrown if the coordinates are not in bounds.
     *
     * @param x The X coordinate of the pixel location.
     * @param y The Y coordinate of the pixel location.
    ...
    /**
     * Sets a sample in the specified band for the pixel located at (x,y) in the <code>DataBuffer</code> using a <code>
     * double</code> for input. <code>ArrayIndexOutOfBoundsException</code> may be thrown if the coordinates are not in
     * bounds.
     *
     * @param x The X coordinate of the pixel location.
     * @param y The Y coordinate of the pixel location.
    ...
    /**
     * Returns all samples for a rectangle of pixels in a <code>double</code> array, one sample per array element.
     * <code>ArrayIndexOutOfBoundsException</code> may be thrown if the coordinates are not in bounds.
     *
    ...
    public double[] getPixels(int x, int y, int w, int h, double dArray[], DataBuffer data) {
        ...
        else pixels = new double[numBands * w * h];
