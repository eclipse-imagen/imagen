 ...
 *
 *      RenderedImage dst = (RenderedImage)ImageN.create("maxfilter", pb);
 * </pre>
 *
...
public class MaxFilterDescriptor extends OperationDescriptorImpl {
    ...
    public static RenderedOp create(
        ...
        ParameterBlockImageN pb = new ParameterBlockImageN("MaxFilter", RenderedRegistryMode.MODE_NAME);
        ...
        return ImageN.create("MaxFilter", pb, hints);
    }
}
