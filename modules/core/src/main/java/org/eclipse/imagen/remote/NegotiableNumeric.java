...
public class NegotiableNumeric implements Negotiable {
     ...
     *
     * @param b The <code>byte</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param s The <code>short</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param i The <code>int</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param l The <code>long</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param f The <code>float</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param d The <code>double</code> to be wrapped to implement <code>Negotiable</code>.
     */
     ...
     *
     * @param n The <code>Number</code> to be wrapped to implement <code>Negotiable</code>.
    ...
    /**
     * Returns the <code>Number</code> that is currently the valid value for this class. A valid primitive data type
     * value, such as int, will be returned as a member of the corresponding wrapper class, such as <code>Integer</code>
     * .
     */
    ...
    /**
     * Returns a <code>NegotiableNumeric</code> that contains the value that is common to this <code>NegotiableNumeric
     * </code> and the one supplied, i.e the <code>Number</code> encapsulated in both the <code>NegotiableNumeric</code>
     * are equal. If the supplied <code>Negotiable</code> is not a <code>NegotiableNumeric</code> with its element being
     * of the same <code>Class</code> as this class', or if there is no common value (i.e the values are not equal), the
    ...
    /**
     * Returns the result of the negotiation as a <code>Number</code> subclass. Values belonging to a base type, such as
     * <code>int</code>, will be returned as a member of the corresponding <code>Number</code> subclass, such as <code>
     * Integer</code>.
     */
    ...
    /**
     * Returns the <code>Class</code> of the negotiated value. Values belonging to a base type, such as <code>int</code>
     * , will be returned as a member of the corresponding <code>Number</code> subclass, such as <code>Integer</code>.
     * The <code>Class</code> returned similarly will be a <code>Number</code> subclass.
     */
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>byte</code>.
     *
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>short</code>.
     *
     * @throws ClassCastException if the value is of a different Class type.
     */
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>int</code>.
     *
     * @throws ClassCastException if the value is of a different Class type.
     */
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>long</code>.
     *
     * @throws ClassCastException if the value is of a different Class type.
     */
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>float</code>.
     *
     * @throws ClassCastException if the value is of a different Class type.
     */
    ...
    /**
     * A convenience method to return the single negotiated value as a <code>double</code>.
     *
     * @throws ClassCastException if the value is of a different Class type.
     */
