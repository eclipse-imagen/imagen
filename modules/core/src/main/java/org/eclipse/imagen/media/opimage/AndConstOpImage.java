...
/**
 * An <code>OpImage</code> implementing the "AndConst" operation.
 *
 * <p>This <code>OpImage</code> logically "ands" the pixels of a rendered image with a set of constants, one for each
...
final class AndConstOpImage extends ColormapOpImage {
    ...
    /** The constants to be anded, one for each band. */
    ...
    /**
     * Logically "ands" a constant to the pixel values within a specified rectangle.
     *
