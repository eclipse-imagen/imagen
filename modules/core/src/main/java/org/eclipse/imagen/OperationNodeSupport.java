...
public class OperationNodeSupport implements Serializable {
     ...
     * PropertyChangeEventImageN</code> named "parameters", and forwarded to any listeners registered with the supplied.
     ...
     * a <code>PropertyChangeEventImageN<code> named "OperationName"
     ...
     * a <code>PropertyChangeEventImageN<code> named "OperationRegistry"
     * will be fired by the event helper object with old and new values
     ...
     * a <code>PropertyChangeEventImageN<code> named "ParameterBlock"
     * will be fired by the event helper object with old and new values
     * set to the old and new values of the <code>ParameterBlock</code>,
     * respectively.  A <code>PropertyChangeEventImageN<code> named "Sources" or
     ...
     * converted to a <code>PropertyChangeEventImageN</code> named "parameters",
     ...
     * a <code>PropertyChangeEventImageN<code> named "RenderingHints"
     * will be fired by the event helper object with old and new values
