...
/**
 * A <code>CRIF</code> supporting the "Magnitude" operation in the rendered image layer.
 *
 * @since Beta
...
public class MagnitudeCRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderHints) {
        ...
        return new MagnitudePhaseOpImage(source, renderHints, layout, MagnitudePhaseOpImage.MAGNITUDE);
    }
}
