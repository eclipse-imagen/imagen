...
public final class UnpackedImageData {
    ...
    /** The rectangular region within the <code>Raster</code> where the data are to be accessed. */
    ...
    /**
     * The number of array elements from the beginning of the data array to the first pixel of the <code>Rectangle
     * </code> for all bands.
     */
    public final int[] bandOffsets;

    /**
     * Indicates whether the <code>PixelAccessor</code> can and must set the data back into the <code>Raster</code>. If
     * the data does not need to be copied back to the <code>Raster</code>, this variable should be set to <code>false
     * </code>. Only destinations can be set.
     */
     ...
     * @param pixelStride The data array increment needed to move from band x of pixel i to band x of pixel i+1 on the
     *     same scanline.
     * @param lineStride The data array increment to move from the pixel x of line i to pixel x of line i+1.
     * @param bandOffsets The number of bytes from the start of the data array to the location of the first pixel of the
     *     rectangle for all bands.
     * @param convertToDest A <code>boolean</code> indicating whether the data can and must be set back into the <code>
     *     Raster</code>. This applies only to destinations.
     */
    public UnpackedImageData(
            Raster raster,
            Rectangle rect,
            int type,
            Object data,
    ...
    /**
     * Returns the two-dimensional byte data array, or <code>null</code> if the data are not stored in a byte array. The
     * array format is <code>data[band][]</code> where the second index is navigated using the pixel and line strides.
     *
    ...
    /**
     * Returns byte data array for a specific band, or <code>null</code> if the data are not stored in a byte array.
     *
    ...
    /**
     * Returns the two-dimensional short data array, or <code>null</code> if the data are not stored in a short array.
     * The array format is <code>data[band][]</code> where the second index is navigated using the pixel and line
     * strides.
     *
     * @return The two-dimensional short data array.
     */
    public short[][] getShortData() {
        return (type == DataBuffer.TYPE_USHORT || type == DataBuffer.TYPE_SHORT) ? (short[][]) data : null;
    }

    /**
     * Returns short data array for a specific band, or <code>null</code> if the data are not stored in a short array.
     *
     * @param b The band whose data array is to be retrieved.
    ...
    /**
     * Returns the two-dimensional integer data array, or <code>null</code> if the data are not stored in an integer
     * array. The array format is <code>data[band][]</code> where the second index is navigated using the pixel and line
     * strides.
     *
    ...
    /**
     * Returns integer data array for a specific band, or <code>null</code> if the data are not stored in an integer
     * array.
     *
     * @param b The band whose data array is to be retrieved.
    ...
    /**
     * Returns the two-dimensional float data array, or <code>null</code> if the data are not stored in a float array.
     * The array format is <code>data[band][]</code> where the second index is navigated using the pixel and line
     * strides.
     *
    ...
    /**
     * Returns float data array for a specific band, or <code>null</code> if the data are not stored in a float array.
     *
     * @param b The band whose data array is to be retrieved.
    ...
    /**
     * Returns the two-dimensional double data array, or <code>null</code> if the data are not stored in a double array.
     * The array format is <code>data[band][]</code> where the second index is navigated using the pixel and line
     * strides.
     *
    ...
    /**
     * Returns double data array for a specific band, or <code>null</code> if the data are not stored in a double array.
     *
     * @param b The band whose data array is to be retrieved.
