 ...
 *
 * <p>For each pixel (x, y) of the destination, the source value at the fractional subpixel position (x - xTrans, y -
...
public class TranslateDescriptor extends OperationDescriptorImpl {
    ...
    /**
     * The resource strings that provide the general documentation and specify the parameter list for the "Translate"
     * operation.
     */
