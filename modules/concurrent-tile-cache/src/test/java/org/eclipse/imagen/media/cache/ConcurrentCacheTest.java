...
public class ConcurrentCacheTest {
    ...
    // @Test
    public double[] testwriteImageAndWatchFlag(
            CacheType cacheUsed,
        ...
        ThreadPoolExecutor pool = new ThreadPoolExecutor(
                threadMaxNumber, threadMaxNumber, 60, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(1000000));
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int f = 0; f < numTest; f++) {
            ...
            dataTest[f] = new ConcurrentCacheTest()
                    .testwriteImageAndWatchFlag(
                            cacheUsed,
                            concurrencyLevel,
                            memoryCacheCapacity,
                            imageSynth,
