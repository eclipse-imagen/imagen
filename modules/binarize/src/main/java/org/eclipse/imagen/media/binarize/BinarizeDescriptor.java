 ...
 * applies a thresholding operation to the produce a bilevel image. Users can define ROI on where the pixel must be
 * calculated, keeping external pixel to 0. Also it is possible to define a nodata variable for setting NoData values
 * always to 0.
 *
...
public class BinarizeDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[] paramNames = {"threshold", "roi", "nodata"};

    /** The parameter class list for this operation. */
    private static final Class[] paramClasses = {
        java.lang.Double.class, org.eclipse.imagen.ROI.class, org.eclipse.imagen.media.range.Range.class
    };
