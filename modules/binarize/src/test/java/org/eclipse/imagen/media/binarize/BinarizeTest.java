...
public class BinarizeTest extends TestBase {
    ...
    public static void initialSetup() {
        ...
        testImages[DataBuffer.TYPE_BYTE] =
                createTestImage(DataBuffer.TYPE_BYTE, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataB, false, 1, (byte)
                        (thresholds[DataBuffer.TYPE_BYTE] + 1));
        testImages[DataBuffer.TYPE_USHORT] =
                createTestImage(DataBuffer.TYPE_USHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataS, false, 1, (short)
                        (thresholds[DataBuffer.TYPE_USHORT] + 1));
        testImages[DataBuffer.TYPE_SHORT] =
                createTestImage(DataBuffer.TYPE_SHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataS, false, 1, (short)
                        (thresholds[DataBuffer.TYPE_SHORT] + 1));
        testImages[DataBuffer.TYPE_INT] =
                createTestImage(DataBuffer.TYPE_INT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataI, false, 1, (int)
                        (thresholds[DataBuffer.TYPE_INT] + 1));
        testImages[DataBuffer.TYPE_FLOAT] =
                createTestImage(DataBuffer.TYPE_FLOAT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataF, false, 1, (float)
                        (thresholds[DataBuffer.TYPE_FLOAT] + 1));
    ...
    public void testRegistration() {
        RegistryElementDescriptor descriptor =
                ImageN.getDefaultInstance().getOperationRegistry().getDescriptor("rendered", "Binarize");
        assertNotNull(descriptor);
        assertEquals("Binarize", descriptor.getName());
        ParameterListDescriptor parameters = descriptor.getParameterListDescriptor("rendered");
        assertArrayEquals(new String[] {"threshold", "roi", "nodata"}, parameters.getParamNames());
    }
}
