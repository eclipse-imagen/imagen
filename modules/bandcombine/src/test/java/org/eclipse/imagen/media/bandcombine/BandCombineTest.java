...
public class BandCombineTest extends TestBase {
    ...
    public static void initialSetup() {
        ...
        testImages[DataBuffer.TYPE_BYTE] =
                createTestImage(DataBuffer.TYPE_BYTE, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataB, false, 3);
        testImages[DataBuffer.TYPE_USHORT] =
                createTestImage(DataBuffer.TYPE_USHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataS, false, 3);
        testImages[DataBuffer.TYPE_SHORT] =
                createTestImage(DataBuffer.TYPE_SHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataS, false, 3);
        testImages[DataBuffer.TYPE_INT] =
                createTestImage(DataBuffer.TYPE_INT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataI, false, 3);
        testImages[DataBuffer.TYPE_FLOAT] =
                createTestImage(DataBuffer.TYPE_FLOAT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataF, false, 3);
        testImages[DataBuffer.TYPE_DOUBLE] =
                createTestImage(DataBuffer.TYPE_DOUBLE, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataD, false, 3);
        IMAGE_FILLER = false;
    ...
    private void testType(RenderedImage src, boolean nodataUsed, boolean roiUsed) {
        ...
        // BandCombined result
        RenderedOp combined = BandCombineDescriptor.create(src, matrix, roi, noData, destinationNoData, null);
    ...
    public void testRegistration() {
        RegistryElementDescriptor descriptor =
                ImageN.getDefaultInstance().getOperationRegistry().getDescriptor("rendered", "BandCombine");
        assertNotNull(descriptor);
        assertEquals("BandCombine", descriptor.getName());
        ParameterListDescriptor parameters = descriptor.getParameterListDescriptor("rendered");
        assertArrayEquals(new String[] {"matrix", "roi", "nodata", "destNoData"}, parameters.getParamNames());
    }
}
