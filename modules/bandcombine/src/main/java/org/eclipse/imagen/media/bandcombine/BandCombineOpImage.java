 ...
 * takes place.
 *
 * <p>If an input sample is outside ROI or it is a NoData, it will be skipped during computation.
 */
            ...
            for (int h = 0; h < dstHeight; h++) {
                ...
                for (int w = 0; w < dstWidth; w++) {
                    ...
                    for (int b = 0; b < dstBands; b++) {
                        ...
                        dstData[b][dstPixelOffset + dstBandOffsets[b]] = ImageUtil.clampRoundByte(sum);
                    }
            ...
            for (int h = 0; h < dstHeight; h++) {
                ...
                for (int w = 0; w < dstWidth; w++) {
                    ...
                    for (int b = 0; b < dstBands; b++) {
                        ...
                        sum += (float) mat[srcBands];
                        dstData[b][dstPixelOffset + dstBandOffsets[b]] = ImageUtil.clampRoundUShort(sum);
                    }
            ...
            for (int h = 0; h < dstHeight; h++) {
                ...
                for (int w = 0; w < dstWidth; w++) {
                    ...
                    for (int b = 0; b < dstBands; b++) {
                        ...
                        sum += (float) mat[srcBands];
                        dstData[b][dstPixelOffset + dstBandOffsets[b]] = ImageUtil.clampRoundShort(sum);
                    }
            ...
            for (int h = 0; h < dstHeight; h++) {
                ...
                for (int w = 0; w < dstWidth; w++) {
                    ...
                    for (int b = 0; b < dstBands; b++) {
                        ...
                        sum += (float) mat[srcBands];
                        dstData[b][dstPixelOffset + dstBandOffsets[b]] = ImageUtil.clampRoundInt(sum);
                    }
