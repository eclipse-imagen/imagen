...
import org.eclipse.imagen.media.scale.ScaleBicubicOpImage;
import org.eclipse.imagen.media.scale.ScaleBilinearOpImage;
import org.eclipse.imagen.media.scale.ScaleGeneralOpImage;
import org.eclipse.imagen.media.scale.ScaleNearestOpImage;
...
public class AffineCRIF extends CRIFImpl {
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderHints) {
        ...
        if ((tr[0] == 1.0)
                ...
                && layout == null
                && (roi == null || (roi.getBounds().isEmpty() || roi.contains(sourceBounds)) && (nodata == null))) {
        ...
        double destinationNoData = (backgroundValues != null && backgroundValues.length > 0) ? backgroundValues[0] : 0;
        ...
        if (nearestInterp && !isBinary) {
            ...
            return new AffineGeneralOpImage(
                    source,
                    extender,
                    renderHints,
                    layout,
            ...
            return new AffineBicubicOpImage(
                    source,
                    extender,
                    renderHints,
                    layout,
