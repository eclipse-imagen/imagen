                    ...
                    if ((s_ix >= src_rect_x1)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            if (w00z && w01z && w10z && w11z) {
                                ...
                                double result = InterpolationBilinear.computeValueDouble(
                                                s00 & 0xff,
                                                s01 & 0xff,
                                                s10 & 0xff,
                                                s11 & 0xff,
                    ...
                    for (int x = clipMinX; x < clipMaxX; x++) {
                        ...
                        if (baseIndex > roiDataLength || w00 == 0 || (w00 == 0 && w01 == 0 && w10 == 0 && w11 == 0)) {
                            ...
                            for (int k2 = 0; k2 < dst_num_bands; k2++) {
                                ...
                                final short s01 =
                                        (short) (srcDataArrays[k2][posxhigh + posy + bandOffsets[k2]] & 0xffff);
                                final short s10 =
                                        (short) (srcDataArrays[k2][posx + posyhigh + bandOffsets[k2]] & 0xffff);
                                final short s11 =
                                        (short) (srcDataArrays[k2][posxhigh + posyhigh + bandOffsets[k2]] & 0xffff);
                        ...
                        if (roiBounds.contains(x0, y0)) {
                            ...
                            if (w00 == 0 && w01 == 0 && w10 == 0 && w11 == 0) {
                                ...
                                for (int k2 = 0; k2 < dst_num_bands; k2++) {
                                    // The interpolated value is saved in the destination array
                                    final short s00 =
                                            (short) (srcDataArrays[k2][posx + posy + bandOffsets[k2]] & 0xffff);
                                    final short s01 =
                                            (short) (srcDataArrays[k2][posxhigh + posy + bandOffsets[k2]] & 0xffff);
                                    final short s10 =
                                            (short) (srcDataArrays[k2][posx + posyhigh + bandOffsets[k2]] & 0xffff);
                    ...
                    if ((s_ix >= src_rect_x1)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            if (w00z && w01z && w10z && w11z) {
                                ...
                                float result = InterpolationBilinear.computeValueDouble(
                                                s00,
                                                s01,
                                                s10,
                                                s11,
