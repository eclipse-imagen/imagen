...
public class AffineBicubicOpImage extends AffineOpImage {
    ...
    private void affineOpInitialization(
            RenderedImage source,
            Interpolation interp,
            ImageLayout layout,
            double[] backgroundValues,
    ...
    protected void computeRect(Raster[] sources, WritableRaster dest, Rectangle destRect) {
        ...
        switch (dataType) {
            ...
            case DataBuffer.TYPE_SHORT:
                ...
                break;
            case DataBuffer.TYPE_USHORT:
                ushortLoop(dataType, srcAccessor, destRect, srcRectX, srcRectY, dstAccessor, roiAccessor, roiIter);
                break;
            case DataBuffer.TYPE_FLOAT:
                floatLoop(dataType, srcAccessor, destRect, srcRectX, srcRectY, dstAccessor, roiAccessor, roiIter);
                break;
            case DataBuffer.TYPE_DOUBLE:
                doubleLoop(dataType, srcAccessor, destRect, srcRectX, srcRectY, dstAccessor, roiAccessor, roiIter);
                break;
        }
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            for (int h = 0; h < KERNEL_LINE_DIM; h++) {
                                ...
                                for (int z = 0; z < KERNEL_LINE_DIM; z++) {
                                    ...
                                    int pixelValue = srcDataArrays[k2][
                                                    pos
                                                            + (z - 1) * srcPixelStride
                        ...
                        if (baseIndex > roiDataLength || roiDataArray[baseIndex] == 0) {
                            ...
                            for (int k2 = 0; k2 < dst_num_bands; k2++) {
                                ...
                                for (int h = 0; h < KERNEL_LINE_DIM; h++) {
                                    for (int z = 0; z < KERNEL_LINE_DIM; z++) {
                                        // Selection of one pixel
                                        pixelKernel[h][z] = srcDataArrays[k2][
                                                        pos
                                                                + (z - 1) * srcPixelStride
                                                                + (h - 1) * srcScanlineStride
                                                                + bandOffsets[k2]]
                    ...
                    if ((s_ix >= src_rect_x11)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            if (weight == 0) {
                                ...
                                sum = 0;
                                // Clamp
                                result = InterpolationBicubic.clampAndFixOvershootingByte(
                                        (int) result, destinationNoDataByte[k2]);
                    ...
                    if ((s_ix >= src_rect_x11)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            if (weight == 0) {
                                ...
                                sum = 0;
                                // Clamp
                                result = InterpolationBicubic.clampAndFixOvershootingUShort(
                                        (int) result, destinationNoDataUShort[k2]);
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            for (int h = 0; h < KERNEL_LINE_DIM; h++) {
                                for (int z = 0; z < KERNEL_LINE_DIM; z++) {
                                    // Selection of one pixel
                                    pixelKernel[h][z] =
                                            bandDataArray[pos + (z - 1) * srcPixelStride + (h - 1) * srcScanlineStride];
                                    if (!noData.contains((short) pixelKernel[h][z])) {
                                        weight |= (1 << (4 * h + z));
                                    } else {
                                        weight &= (0xffff - (1 << 4 * h + z));
                    ...
                    if ((s_ix >= src_rect_x11)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            for (int h = 0; h < KERNEL_LINE_DIM; h++) {
                                ...
                                for (int z = 0; z < KERNEL_LINE_DIM; z++) {
                                    // Selection of one pixel
                                    float pixelValue = srcDataArrays[k2][
                                            pos
                                                    + (z - 1) * srcPixelStride
                                                    + (h - 1) * srcScanlineStride
                                                    + bandOffsets[k2]];
                    ...
                    if ((s_ix >= src_rect_x11)
                        ...
                        for (int k2 = 0; k2 < dst_num_bands; k2++) {
                            ...
                            for (int h = 0; h < KERNEL_LINE_DIM; h++) {
                                ...
                                for (int z = 0; z < KERNEL_LINE_DIM; z++) {
                                    // Selection of one pixel
                                    double pixelValue = srcDataArrays[k2][
                                            pos
                                                    + (z - 1) * srcPixelStride
                                                    + (h - 1) * srcScanlineStride
                                                    + bandOffsets[k2]];
