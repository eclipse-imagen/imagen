 ...
 *
 * <p>This new version of the "Affine" operation adds the ROI support and No Data support for every image type and even
 * for Binary images. This extension becames possible with 3 new Interpolation extensions, each of them is an evolution
 * of the classic interpolation method: InterpolationNearest, InterpolationBilinear, InterpolationBicubicNew. The No
 * Data Range used must be defined inside the interpolator, at the interpolator creation time, while the ROI support is
 * handled inside the AffineGeneralOpImage.
 *
 * <p>
 *
 * <table border=1>
 ...
 *                            <td>False</td>
 * <tr><td>nodata</td>        <td>org.eclipse.imagen.media.range.Range</td>
 *                            <td>null</td>
 * </table>
 *
...
public class AffineDescriptor extends OperationDescriptorImpl {
    ...
    private static final Object[] paramDefaults = {
        new AffineTransform(), Interpolation.getInstance(Interpolation.INTERP_NEAREST), null, null, false, false, null
    };
