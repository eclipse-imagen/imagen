...
final class WarpGeneralOpImage extends WarpOpImage {
    ...
    protected void computeRectByte(
            PlanarImage src, RasterAccessor dst, final RandomIter roiIter, boolean roiContainsTile) {
                            ...
                            for (int b = 0; b < dstBands; b++) {
                                for (int j = 0; j < kheight; j++) {
                                    for (int i = 0; i < kwidth; i++) {
                                        ...
                                        samples[j][i] =
                                                byteLookupTable[b][iter.getSample(xint + i, yint + j, b) & 0xFF];
                                    }
                                }
