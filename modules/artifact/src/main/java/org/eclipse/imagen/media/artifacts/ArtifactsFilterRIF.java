...
public class ArtifactsFilterRIF implements RenderedImageFactory {
     ...
     *
     * @param paramBlock specifies the source image, and the following parameters: "roi", "backgroundValues",
     *     "threshold", "filterSize", "nodata"
    ...
    public RenderedImage create(ParameterBlock paramBlock, RenderingHints renderingHints) {
        ...
        return new ArtifactsFilterOpImage(
                dataImage, layout, renderingHints, roi, bgValues, threshold, filterSize, nodata);
    }
}
