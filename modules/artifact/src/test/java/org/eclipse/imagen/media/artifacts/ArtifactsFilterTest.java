...
public class ArtifactsFilterTest extends TestBase {
    ...
    private void testArtifact(int dataType, RenderedImage image, Range nodata) {
        ...
        RenderedOp histogramOp = StatisticsDescriptor.create(
                image,
                1,
                1,
                null,
        ...
        Statistics[][] results = (Statistics[][]) histogramOp.getProperty(Statistics.STATS_PROPERTY);
        ...
        assertEquals(
                bins[0][200], 5041); // This bin will disappear in the Histogram of the filtered image (NoData check)
        assertEquals(
                bins[2][200], 5041); // This bin will disappear in the Histogram of the filtered image (NoData check)
        ...
        RenderedImage filtered = ArtifactsFilterDescriptor.create(image, roi, backgroundValues, 30, 3, nodata, null);
        histogramOp = StatisticsDescriptor.create(
                filtered,
                1,
                1,
                null,
