...
/**
 * This test class is used for expanding the code coverage of the jt-lookup project. This purpose is reached by testing
 * all the LookupTable construction method, both by giving exact data arrays and by giving null data arrays. If the
 * input array is null an IllegalArgumentException is thrown.
 */
