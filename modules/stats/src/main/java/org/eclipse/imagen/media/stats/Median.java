...
/**
 * This subclass of {@link Statistics} is used for calculating the median of an image. This operation is performed by
 * saving alist of all the pixel values. When the result is requested, the list is sorted and then the middle value is
 * taken. If the list size is even, then the mean of the 2 middle values.
 */
