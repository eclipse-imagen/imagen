 ...
 * The input parameters are: ParameterBlock, RenderingHints. The first one stores all the input parameters, the second
 * stores eventual hints used for changing the image settings. The create() method could return a new instance of the
 * {@link SimpleStatsOpImage} operation or a new instance of the {@link ComplexStatsOpImage}.
 */
public class StatisticsRIF implements RenderedImageFactory {
    ...
    public RenderedImage create(ParameterBlock pb, RenderingHints hints) {
        ...
        if (isSimpleStat) {
            ...
            return new ComplexStatsOpImage(
                    source,
                    xPeriod,
                    yPeriod,
                    roi,
