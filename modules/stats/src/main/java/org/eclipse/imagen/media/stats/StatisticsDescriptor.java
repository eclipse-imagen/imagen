 ...
 *
 * <p>The SimpleStats operation takes in input a source image and an array indicating which bands to analyze and which
 * kind of statistics can be done. More statistics can be computed inside the same image. The possible statistics are:
 *
 * <p>
 *
 * <ul>
 ...
 * and then calling the getResult() method.
 *
 * <p>
 *
 * <table border=1>
...
public class StatisticsDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[] paramNames = {
        "xPeriod", "yPeriod", "ROI", "noData", "useRoiAccessor", "bands", "stats", "lowValue", "highValue", "numBins"
    };

    /** The parameter default value list for this operation. */
    private static final Object[] paramDefaults = {
        1, 1, null, null, false, new int[] {0}, null, new double[] {0.0}, new double[] {256.0}, new int[] {256}
    };
