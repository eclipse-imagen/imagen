...
/**
 * This test class is used for compare the timing between the new and the old versions of the Border operator . If the
 ...
 * descriptor must be done by setting to true or false the JVM parameter JAI.Ext.OldDescriptor. No Data Range can be
 * used by simply setting to true the JAI.Ext.RangeUsed JVM parameter. For selecting which BorderExtender to use the
 * user must set a value from 0 to 3 to the JVM Integer parameter JAI.Ext.BorderType.
 */
