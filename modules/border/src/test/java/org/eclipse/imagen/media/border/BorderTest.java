 ...
 *   <li>BorderExtenderCopy
 *   <li>BorderExtenderReflect
 *   <li>BorderExtenderWrap
 * </ul>
 *
...
public class BorderTest extends TestBase {
    ...
    public static void initialSetup() {
        ...
        sourceIMG[DataBuffer.TYPE_BYTE] =
                createTestImage(DataBuffer.TYPE_BYTE, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataB, false, 1);
        sourceIMG[DataBuffer.TYPE_USHORT] =
                createTestImage(DataBuffer.TYPE_USHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataU, false, 1);
        sourceIMG[DataBuffer.TYPE_SHORT] =
                createTestImage(DataBuffer.TYPE_SHORT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataS, false, 1);
        sourceIMG[DataBuffer.TYPE_INT] =
                createTestImage(DataBuffer.TYPE_INT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataI, false, 1);
        sourceIMG[DataBuffer.TYPE_FLOAT] =
                createTestImage(DataBuffer.TYPE_FLOAT, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataF, false, 1);
        sourceIMG[DataBuffer.TYPE_DOUBLE] =
                createTestImage(DataBuffer.TYPE_DOUBLE, DEFAULT_WIDTH, DEFAULT_HEIGHT, noDataD, false, 1);
        ...
        extenders[BorderExtender.BORDER_ZERO] = BorderExtender.createInstance(BorderExtender.BORDER_ZERO);
        extenders[BorderExtender.BORDER_COPY] = BorderExtender.createInstance(BorderExtender.BORDER_COPY);
        extenders[BorderExtender.BORDER_REFLECT] = BorderExtender.createInstance(BorderExtender.BORDER_REFLECT);
        extenders[BorderExtender.BORDER_WRAP] = BorderExtender.createInstance(BorderExtender.BORDER_WRAP);
    ...
    public void testPackedImage() {
        ...
        int[] dataTypes = new int[] {DataBuffer.TYPE_BYTE, DataBuffer.TYPE_USHORT, DataBuffer.TYPE_INT};
        for (int dataType : dataTypes) {
            for (int borderType = 0; borderType < extenders.length; borderType++) {
                ...
                RenderedImage image = createTestImage(DEFAULT_WIDTH, DEFAULT_HEIGHT, 0, 1, validData, sm);
                ...
                // Border operation execution
                RenderedOp borderImg = BorderDescriptor.create(
                        image, leftPad, rightPad, topPad, bottomPad, extender, noDataRange, destNoData, null);
