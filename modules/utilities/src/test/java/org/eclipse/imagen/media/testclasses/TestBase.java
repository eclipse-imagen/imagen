...
public abstract class TestBase {
    ...
    public static RenderedImage createTestImage(
            int dataType, int width, int height, Number noDataValue, boolean isBinary) {

        return createTestImage(dataType, width, height, noDataValue, isBinary, 3);
    }

    public static RenderedImage createTestImage(
            int dataType, int width, int height, Number noDataValue, boolean isBinary, int bands) {
        return createTestImage(dataType, width, height, noDataValue, isBinary, bands, null);
    }

    /** Simple method for image creation */
    public static RenderedImage createTestImage(
            int dataType, int width, int height, Number noDataValue, boolean isBinary, int numBands, Number validData) {
    ...
    protected static RenderedImage createIndexedImage(
            int defaultWidth, int defaultHeight, boolean transparentPixel, boolean addAlpha) {
        IndexColorModel icm;
        int SIZE = 255;
        byte[] reds = new byte[SIZE];
        byte[] greens = new byte[SIZE];
