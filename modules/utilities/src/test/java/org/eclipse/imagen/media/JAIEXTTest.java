...
public class JAIEXTTest {
    ...
    public static void setup() throws FileNotFoundException, IOException {
        final File inputJAIFile = TestData.file(JAIEXTTest.class, "META-INF" + File.separator + "registryFile2.jaiext");
        newJAIFile = new File(
                inputJAIFile
                        .getParentFile()
                        .getParentFile()
    ...
    public void testJAIEXT() {
        ...
        assertTrue(operationItem.getDescriptor().getClass().isAssignableFrom(DummyScaleDescriptor.class));
        // Also check that the associated RIF is an instance of the DummyScaleCRIF class
        assertTrue(operationItem.getCurrentFactory().getClass().isAssignableFrom(DummyScaleCRIF.class));
