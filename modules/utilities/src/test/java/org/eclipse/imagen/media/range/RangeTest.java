 ...
 *
 * <p>Guava Ranges are commented in order to wait to upgrade the Guava version to 14.0.1
 */
public class RangeTest {
    ...
    //    public <T extends Number & Comparable<T>>void testGeoToolsRangeTime(org.geotools.util.Range<T> testRange,
    ...
    //            long end = System.nanoTime() - start;
    //
    //            // If the the first NOT_BENCHMARK_ITERATION cycles has been done, then the mean, maximum and minimum
    // values are stored
    //            if (i > NOT_BENCHMARK_ITERATION - 1) {
    //                if (i == NOT_BENCHMARK_ITERATION) {
    //                    mean = end;
