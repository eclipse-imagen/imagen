...
public class ImageUtilities {
    ...
    /**
     * Returns {@code true} if the specified {@code type} is one of integer types. Integer types includes {@link Long},
    ...
    /**
     * Creates a new TiledImage object with a single band of constant value. The data type of the image corresponds to
     * the class of {@code value}.
     *
    ...
    /**
     * Creates a new TiledImage object with one or more bands of constant value. The number of bands in the output image
     * corresponds to the length of the input values array and the data type of the image corresponds to the
     ...
     * @return a new TiledImage object
     */
    public static TiledImage createConstantImage(
            int minx, int miny, int width, int height, int tileWidth, int tileHeight, Number[] values) {
        ...
        if (values[0] instanceof Double) {
            ...
            throw new UnsupportedOperationException(
                    "Unsupported data type: " + values[0].getClass().getName());
        }
    ...
    /**
     * Creates a new single-band TiledImage with the provided values. The {@code array} argument must be of length
    ...
    public static TiledImage createImageFromArray(Number[] array, int width, int height) {
        ...
        if (array[0] instanceof Double) {
            ...
            throw new UnsupportedOperationException(
                    "Unsupported data type: " + array[0].getClass().getName());
        }
    ...
    /**
     * Create a set of colours using a simple colour ramp algorithm in the HSB colour space. All float arguments should
     ...
     * @return an array of colours sampled from the HSB space between the start and end hues
     */
    public static Color[] createRampColours(
            int numColours, float startHue, float endHue, float saturation, float brightness) {
    ...
    /**
     * Creates a proxy RGB display image for the given data image. The data image should be of integral data type. Only
     * the first band of multi-band images will be used.
     *
    ...
    /**
     * Get the bands of a multi-band image as a list of single-band images. This can be used, for example, to separate
     * the result image returned by the KernelStats operator into separate result images.
     *
    ...
    /**
     * Get the specified bands of a multi-band image as a list of single-band images. This can be used, for example, to
     * separate the result image returned by the KernelStats operator into separate result images.
     *
     * @param img the multi-band image
