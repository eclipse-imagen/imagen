...
/**
 * A path iterator for the LiteShape class, specialized to iterate over LineString object. This class was ported back
 * and simplified from GeoTools, with permission from the author(s)
 *
 * @author Andrea Aime
