...
public class ImageLayout2 extends ImageLayout {
     ...
     * @param minY the image's minimum X coordinate.
     * @param width the image's width.
     * @param height the image's height.
     * @param tileGridXOffset the x coordinate of the tile (0,0)
     * @param tileGridYOffset the y coordinate of the tile (0,0)
     * @param tileWidth the tile's width.
     * @param tileHeight the tile's height.
     * @param sampleModel the image's {@link SampleModel}
     * @param colorModel the image's {@link ColorModel}
     */
    public ImageLayout2(
            final int minX,
            final int minY,
    ...
    /**
     * Construct an {@link ImageLayout2} with only tiling layout properties, sampleModel and colorModel set.
     *
     * @param tileGridXOffset the x coordinate of the tile (0,0)
     * @param tileGridYOffset the y coordinate of the tile (0,0)
     * @param tileWidth the tile's width.
     ...
     * @param height the image's height.
     */
    public ImageLayout2(final int minX, final int minY, final int width, final int height) {
        super(minX, minY, width, height);
    }

    /**
     * Construct an {@link ImageLayout2} on top of a RenderedImage. The layout parameters are set from the related
    ...
    /**
     * Returns the hash code for this {@link ImageLayout2}. With respect to the super {@link ImageLayout}, this method
     * also does validity check on the parameters during hashing.
     */
    @Override
    public int hashCode() {
        int code = 0, i = 1;
