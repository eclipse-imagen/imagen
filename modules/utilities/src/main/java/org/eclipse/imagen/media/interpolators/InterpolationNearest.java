...
public class InterpolationNearest extends Interpolation implements InterpolationNoData {
    ...
    /**
     * Simple interpolator object used for Nearest-Neighbor interpolation. On construction it is possible to set a range
    ...
    public Number interpolate(
        ...
        switch (dataType) {
            ...
            case DataBuffer.TYPE_FLOAT:
                ...
                if ((noDataRange != null && (noDataRange).contains(srcDataFloat))
                        || (isNotPointRange && Float.isNaN(srcDataFloat))
                        || setNoData) {
                    return destinationNoData;
                }
            ...
            case DataBuffer.TYPE_DOUBLE:
                ...
                if ((noDataRange != null && (noDataRange).contains(srcDataDouble))
                        || (isNotPointRange && Double.isNaN(srcDataDouble))
                        || setNoData) {
                    return destinationNoData;
                }
