 ...
 * composite, since uses in fact other, simpler iterator to carry on its duties. This class was ported back and
 * simplified from GeoTools, with permission from the author(s)
 *
 * @author Andrea Aime
 */
public final class GeomCollectionIterator extends AbstractLiteIterator {
     ...
     * @param at The affine transform applied to coordinates during iteration distance from the previous is less than
     *     maxDistance
     */
