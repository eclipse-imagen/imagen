...
public class RangeInt extends Range {
    ...
    public static RangeInt FULL_RANGE = new RangeInt(Integer.MIN_VALUE, true, Integer.MAX_VALUE, true);
    ...
    public RangeInt union(Range other) {
        if (this.contains(other)) {
            return this;
        } else if (other.contains(this)) {
            return (RangeInt) RangeFactory.convert(other, DataType.INTEGER);
        }
    ...
    @Override
    public RangeInt intersection(Range other) {
