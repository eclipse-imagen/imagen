...
public class BandsPropertyTest extends RuntimeTestBase {
    ...
    public void testCopyBandsDirect() throws Exception {
        ...
        TiledImage destImg = ImageUtilities.createConstantImage(
                srcImg.getMinX(), srcImg.getMinY(), srcImg.getWidth(), srcImg.getHeight(), new Double[] {0d, 0d, 0d});
    ...
    public void testSumBands() throws Exception {
        String script = "sum = 0;\n"
                ...
                + "}";
        TiledImage srcImg = ImageUtilities.createConstantImage(10, 10, new Integer[] {1, 2, 3, -9999});
        ...
        JiffleDirectRuntime runtime = jiffle.getRuntimeInstance();
        TiledImage destImg = ImageUtilities.createConstantImage(
                srcImg.getMinX(), srcImg.getMinY(), srcImg.getWidth(), srcImg.getHeight(), new Double[] {
                    0d, 0d, 0d, 0d, 0d, 0d
                });
        runtime.setSourceImage("src", srcImg);
        runtime.setDestinationImage("dst", destImg);
