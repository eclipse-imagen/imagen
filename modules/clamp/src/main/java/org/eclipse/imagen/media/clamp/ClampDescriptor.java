...
public class ClampDescriptor extends OperationDescriptorImpl {
    ...
    private static final String[] paramNames = {"noData", "destinationNoData", "roi", "low", "high"};
    ...
    private static final Object[] paramDefaults = {null, 0d, null, new double[] {0.0}, new double[] {255.0}};
